...
public class GT_ItemMaxStacksizeLoader
    ...
    public void run() {
        ...
        Items.field_179570_aq.func_77625_d(8);
        Items.field_151139_aw.func_77625_d(8);
        if (OrePrefixes.plank.mDefaultStackSize < 64) {
            Item.func_150898_a(Blocks.field_150376_bx).func_77625_d(OrePrefixes.plank.mDefaultStackSize);
            Item.func_150898_a(Blocks.field_150334_T).func_77625_d(OrePrefixes.plank.mDefaultStackSize);
            Item.func_150898_a(Blocks.field_150476_ad).func_77625_d(OrePrefixes.plank.mDefaultStackSize);
        }
