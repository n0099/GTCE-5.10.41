...
public abstract class GT_Proxy implements IGT_Mod, IGuiHandler, IFuelHandler {
    ...
    private static void registerRecipes(OreDictEventContainer aOre) {
        if ((aOre.mEvent.getOre() == null) || (aOre.mEvent.getOre().func_77973_b() == null)) {
            return;
        }
        if (aOre.mEvent.getOre().field_77994_a != 1) {
            aOre.mEvent.getOre().field_77994_a = 1;
        }
    ...
    public void onPreLoad() {
        ...
        for (FluidContainerRegistry.FluidContainerData tData : FluidContainerRegistry.getRegisteredFluidContainerData()) {
            if ((tData.filledContainer.func_77973_b() == Items.field_151068_bn) && (tData.filledContainer.func_77952_i() == 0)) {
    ...
    public void onPostLoad() {
        ...
        GT_OreDictUnificator.addItemData(new ItemStack(Items.field_179572_au, 1, 32767), new ItemData(Materials.Wood, 21772800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(new ItemStack(Items.field_179568_as, 1, 32767), new ItemData(Materials.Wood, 21772800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(new ItemStack(Items.field_179567_at, 1, 32767), new ItemData(Materials.Wood, 21772800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(new ItemStack(Items.field_179570_aq, 1, 32767), new ItemData(Materials.Wood, 21772800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(new ItemStack(Items.field_179569_ar, 1, 32767), new ItemData(Materials.Wood, 21772800L, new MaterialStack[0]));
        GT_OreDictUnificator.addItemData(new ItemStack(Items.field_179571_av, 1, 32767), new ItemData(Materials.Wood, 21772800L, new MaterialStack[0]));
        for (FluidContainerRegistry.FluidContainerData tData : FluidContainerRegistry.getRegisteredFluidContainerData()) {
            if ((tData.filledContainer.func_77973_b() == Items.field_151068_bn) && (tData.filledContainer.func_77952_i() == 0)) {
                tData.fluid.amount = 0;
                break;
...
//                }
    ...
    public void onArrowNockEvent(ArrowNockEvent aEvent) {
        if ((!aEvent.isCanceled()) && (GT_Utility.isStackValid(aEvent.getBow()))
                && (GT_Utility.getProjectile(SubTag.PROJECTILE_ARROW, aEvent.getEntityPlayer().field_71071_by) != null)) {
    ...
    public void onArrowLooseEvent(ArrowLooseEvent aEvent) {
        ItemStack aArrow = GT_Utility.getProjectile(SubTag.PROJECTILE_ARROW, aEvent.getEntityPlayer().field_71071_by);
        if ((!aEvent.isCanceled()) && (GT_Utility.isStackValid(aEvent.getBow())) && (aArrow != null) && ((aEvent.getBow().func_77973_b() instanceof ItemBow))) {
            ...
            EntityArrow tArrowEntity = ((IProjectileItem) aArrow.func_77973_b()).getProjectile(SubTag.PROJECTILE_ARROW, aArrow, aEvent.getEntityPlayer().field_70170_p,
                    aEvent.getEntityPlayer(), tSpeed * 2.0F);
            if (tSpeed >= 1.0F) {
                tArrowEntity.func_70243_d(true);
            }
            int tLevel = EnchantmentHelper.func_77506_a(Enchantments.field_185309_u, aEvent.getBow());
            if (tLevel > 0) {
                tArrowEntity.func_70239_b(tArrowEntity.func_70242_d() + tLevel * 0.5D + 0.5D);
            }
            tLevel = EnchantmentHelper.func_77506_a(Enchantments.field_185310_v, aEvent.getBow());
            if (tLevel > 0) {
                tArrowEntity.func_70240_a(tLevel);
            }
            tLevel = EnchantmentHelper.func_77506_a(Enchantments.field_185311_w, aEvent.getBow());
            if (tLevel > 0) {
                tArrowEntity.func_70015_d(tLevel * 100);
            }
            aEvent.getBow().func_77972_a(1, aEvent.getEntityPlayer());
            aEvent.getEntityPlayer().field_70170_p.func_184133_a(null, new BlockPos(aEvent.getEntity()),
                    SoundEvents.field_187737_v, SoundCategory.PLAYERS,
                    1.0F, 0.64893958288F + tSpeed * 0.5F);

            if (!aEvent.getEntityPlayer().field_71075_bZ.field_75098_d) {
                aArrow.field_77994_a -= 1;
            }

            if (aArrow.field_77994_a == 0) {
                GT_Utility.removeNullStacksFromInventory(aEvent.getEntityPlayer().field_71071_by);
            }

            if (!aEvent.getEntityPlayer().field_70170_p.field_72995_K) {
                aEvent.getEntityPlayer().field_70170_p.func_72838_d(tArrowEntity);
            }
    ...
    public void onEndermanTeleportEvent(EnderTeleportEvent aEvent) {
        if (aEvent.getEntity() instanceof EntityEnderman && aEvent.getEntityLiving()
                .func_70660_b(MobEffects.field_76437_t) != null) {
            aEvent.setCanceled(true);
        }
    }
    ...
    public void onEntitySpawningEvent(EntityJoinWorldEvent aEvent) {
        if (aEvent.getEntity() != null && !aEvent.getEntity().field_70170_p.field_72995_K) {
            if (aEvent.getEntity() instanceof EntityItem) {
                ((EntityItem) aEvent.getEntity()).func_92058_a(GT_OreDictUnificator.get(((EntityItem) aEvent.getEntity()).func_92059_d()));
            }
            if ((this.mSkeletonsShootGTArrows > 0) && (aEvent.getEntity().getClass() == EntityArrow.class)
                    && (aEvent.getEntity().field_70170_p.field_73012_v.nextInt(this.mSkeletonsShootGTArrows) == 0)
                    && ((((EntityArrow) aEvent.getEntity()).field_70250_c instanceof EntitySkeleton))) {
                aEvent.getWorld().func_72838_d(new GT_Entity_Arrow(aEvent.getWorld(),
                        (EntityLivingBase) ((EntityArrow) aEvent.getEntity()).field_70250_c,
                        OrePrefixes.arrowGtWood.mPrefixedItems
                                .get(aEvent.getWorld().field_73012_v.nextInt(OrePrefixes.arrowGtWood.mPrefixedItems.size()))));
                aEvent.getEntity().func_70106_y();
            }
        }
    }
    ...
    public void onPlayerInteraction(PlayerInteractEvent.RightClickBlock aEvent) {
        ...
        if (aStack != null && aStack.func_77973_b() == Items.field_151033_d) {
            if (!aEvent.getWorld().field_72995_K &&
                    !aEvent.getEntityPlayer().field_71075_bZ.field_75098_d &&
                    aEvent.getWorld().field_73012_v.nextInt(100) >= this.mFlintChance) {
                aStack.func_77972_a(1, aEvent.getEntityPlayer());
                if (aStack.func_77952_i() >= aStack.func_77958_k())
    ...
    public void onBlockHarvestingEvent(BlockEvent.HarvestDropsEvent aEvent) {
        if (aEvent.getHarvester() != null) {
            ItemStack aStack = aEvent.getHarvester().func_184614_ca();
            if (aStack != null) {
                if ((aStack.func_77973_b() instanceof GT_MetaGenerated_Tool)) {
                    ((GT_MetaGenerated_Tool) aStack.func_77973_b())
                ...
                if (EnchantmentHelper.func_77506_a(Enchantments.field_77334_n, aStack) > 2) {
    ...
    public void registerOre(OreDictionary.OreRegisterEvent aEvent) {
        ...
        if ((aEvent == null) || (aEvent.getOre() == null) || (aEvent.getOre().func_77973_b() == null) || (aEvent.getName() == null) || (aEvent.getName().isEmpty())
        ...
        try {
            aEvent.getOre().field_77994_a = 1;
            if (this.mIgnoreTcon || aEvent.getOre().func_77977_a().startsWith("item.oreberry")) {
            ...
            if(aEvent.getOre().func_77973_b() instanceof ItemIC2FluidContainer) {
            ...
            if (((aEvent.getOre().func_77973_b() instanceof ItemBlock)) || (GT_Utility.getBlockFromStack(aEvent.getOre()) != null)) {
                GT_OreDictUnificator.addToBlacklist(aEvent.getOre());
            }
            ...
            if (this.mIgnoredItems.contains(aEvent.getName())) {
                ...
                aEvent.getOre().func_151001_c("Invalid OreDictionary Tag");
                return;
            ...
            if ((aPrefix == OrePrefixes.nugget) && (aMod.equals("Thaumcraft")) && (aEvent.getOre().func_77973_b().func_77658_a().contains("ItemResource"))) {
                return;
            }
            if (aPrefix == null) {
                            ...
                            if (aMaterial != Materials._NULL) {
                                ...
                                switch (aPrefix) {
                                    ...
                                    case ingot:
                                        ...
                                        } else if ((aMaterial == Materials.Brass) && (aEvent.getOre().func_77952_i() == 2)
                                                && (aEvent.getOre().func_77977_a().equals("item.ingotBrass"))
                                                && (new ItemStack(aEvent.getOre().func_77973_b(), 1, 0).func_77977_a().contains("red"))) {
                                            GT_OreDictUnificator.set(OrePrefixes.ingot, Materials.RedAlloy, new ItemStack(aEvent.getOre().func_77973_b(), 1, 0));
                                            GT_OreDictUnificator.set(OrePrefixes.ingot, Materials.BlueAlloy, new ItemStack(aEvent.getOre().func_77973_b(), 1, 1));
                                            GT_OreDictUnificator.set(OrePrefixes.ingot, Materials.Brass, new ItemStack(aEvent.getOre().func_77973_b(), 1, 2));
                                            if (!mDisableIC2Cables) {
                                                GT_Values.RA.addWiremillRecipe(
                                                        GT_ModHandler.getIC2Item(ItemName.cable, CableType.copper, 3),
                                                        new ItemStack(aEvent.getOre().func_77973_b(), 1,
                                                                8), 400, 1);
                                                GT_Values.RA.addWiremillRecipe(
                                                        GT_ModHandler.getIC2Item(ItemName.cable, CableType.iron, 6),
                                                        new ItemStack(aEvent.getOre().func_77973_b(), 1, 9), 400, 2);
                                            }
                                            GT_Values.RA.addCutterRecipe(new ItemStack(aEvent.getOre().func_77973_b(), 1, 3), new ItemStack(aEvent.getOre().func_77973_b(), 16, 4),
                                                    null, 400, 8);
                                        }
                                        break;
                                    default:
    ...
    public void onFluidContainerRegistration(FluidContainerRegistry.FluidContainerRegisterEvent aFluidEvent) {
        if ((aFluidEvent.getData().filledContainer.func_77973_b() == Items.field_151068_bn) && (aFluidEvent.getData().filledContainer.func_77952_i() == 0)) {
    ...
    public void onWorldTickEvent(TickEvent.WorldTickEvent aEvent) {
        if(aEvent.world.field_73011_w.getDimension() == 0)
        ...
        if (aEvent.side.isServer()) {
            ...
            if ((aEvent.world.func_82737_E() % 100L == 0L) && ((this.mItemDespawnTime != 6000) || (this.mMaxEqualEntitiesAtOneSpot > 0))) {
                for (int i = 0; i < aEvent.world.field_72996_f.size(); i++) {
                    if ((aEvent.world.field_72996_f.get(i) instanceof Entity)) {
                        Entity tEntity = aEvent.world.field_72996_f.get(i);
                        if (((tEntity instanceof EntityItem)) && (this.mItemDespawnTime != 6000) && (((EntityItem) tEntity).lifespan == 6000)) {
                            ((EntityItem) tEntity).lifespan = this.mItemDespawnTime;
                                ...
                                && (tEntity.func_70104_M()) && (((EntityLivingBase) tEntity).func_110143_aJ() > 0.0F)) {
                            AxisAlignedBB boundingBox = tEntity.func_70046_E();
                            if (boundingBox != null) {
                                List tList = tEntity.field_70170_p.func_72839_b(tEntity, boundingBox.func_72314_b(0.2D, 0.0D, 0.2D));
                                ...
                                if (tEntityCount > this.mMaxEqualEntitiesAtOneSpot) {
                                    tEntity.func_70097_a(DamageSource.field_76368_d, tEntityCount - this.mMaxEqualEntitiesAtOneSpot);
                                }
                            }
                        }
                    }
            ...
            if (aEvent.world.field_73011_w.getDimension() == 0)
                GT_Pollution.onWorldTick(aEvent.world, (int) (aEvent.world.func_82737_E() % 1200));
        }
    }
    ...
    public void onPlayerTickEventServer(TickEvent.PlayerTickEvent aEvent) {
        if ((aEvent.side.isServer()) && (aEvent.phase == TickEvent.Phase.END) && (!aEvent.player.field_70128_L)) {
            if ((aEvent.player.field_70173_aa % 200 == 0) && (aEvent.player.field_71075_bZ.field_75099_e) && (!aEvent.player.field_71075_bZ.field_75098_d)
                    && (this.mSurvivalIntoAdventure)) {
                aEvent.player.func_71033_a(GameType.ADVENTURE);
                ...
                if (this.mAxeWhenAdventure) {
                    ...
                    aEvent.player.field_70170_p.func_72838_d(new EntityItem(aEvent.player.field_70170_p, aEvent.player.field_70165_t, aEvent.player.field_70163_u,
                            aEvent.player.field_70161_v, GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(GT_MetaGenerated_Tool_01.AXE, 1, Materials.Flint, Materials.Wood, null)));
                }
            }
            boolean tHungerEffect = (this.mHungerEffect) && (aEvent.player.field_70173_aa % 2400 == 1200);
            if (aEvent.player.field_70173_aa % 120 == 0) {
                int tCount = 64;
                for (int i = 0; i < 36; i++) {
                    ItemStack tStack;
                    if ((tStack = aEvent.player.field_71071_by.func_70301_a(i)) != null) {
                        if (!aEvent.player.field_71075_bZ.field_75098_d) {
                            GT_Utility.applyRadioactivity(aEvent.player, GT_Utility.getRadioactivityLevel(tStack), tStack.field_77994_a);
                ...
                for (int i = 0; i < 4; i++) {
                    ItemStack tStack;
                    if ((tStack = aEvent.player.field_71071_by.field_70460_b[i]) != null) {
                        if (!aEvent.player.field_71075_bZ.field_75098_d) {
                            GT_Utility.applyRadioactivity(aEvent.player, GT_Utility.getRadioactivityLevel(tStack), tStack.field_77994_a);
                            float tHeat = GT_Utility.getHeatDamageFromItem(tStack);
                            if (tHeat != 0.0F) {
                ...
                if (tHungerEffect) {
                    aEvent.player.func_71020_j(Math.max(1.0F, tCount / 666.6F));
                }
            }
        }
    }
    ...
    public Object getServerGuiElement(int aID, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ) {
        if(aID>=1000){
            ...
            switch(ID){
                case 0:
                    return new ContainerBasicArmor(aPlayer, new InventoryArmor(ModularArmor_Item.class, aPlayer.func_184614_ca()));
                case 1:
                    return new ContainerElectricArmor1(aPlayer, new InventoryArmor(ModularArmor_Item.class, aPlayer.func_184614_ca()));
                case 2:
                    return new ContainerElectricArmor1(aPlayer, new InventoryArmor(ModularArmor_Item.class, aPlayer.func_184614_ca()));
                default:
    ...
    public Object getRightItem(EntityPlayer player, int ID){
        ItemStack mStack = player.func_184582_a(EntityEquipmentSlot.values()[ID/100]);
    ...
    public Object getClientGuiElement(int aID, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ) {
        if(aID>=1000){
            ...
            switch(ID){
                case 0:
                    return new GuiModularArmor(new ContainerBasicArmor(aPlayer, new InventoryArmor(ModularArmor_Item.class, aPlayer.func_184614_ca())), aPlayer);
                case 1:
                    return new GuiElectricArmor1(new ContainerElectricArmor1(aPlayer, new InventoryArmor(ModularArmor_Item.class, aPlayer.func_184614_ca())), aPlayer);
                case 2:
                    return new GuiElectricArmor1(new ContainerElectricArmor1(aPlayer, new InventoryArmor(ModularArmor_Item.class, aPlayer.func_184614_ca())), aPlayer);
                default:
    ...
    public Object getRightItemGui(EntityPlayer player, int ID){
        ItemStack mStack = player.func_184582_a(EntityEquipmentSlot.values()[ID/100]);
        if(mStack==null||!(mStack.func_77973_b() instanceof ModularArmor_Item))return null;
    ...
    public int getBurnTime(ItemStack aFuel) {
        ...
        if ((aFuel.func_77973_b() instanceof GT_MetaGenerated_Item)) {
            Short tFuelValue = ((GT_MetaGenerated_Item) aFuel.func_77973_b()).mBurnValues.get((short) aFuel.func_77952_i());
            if (tFuelValue != null) {
        ...
        } else if (GT_Utility.areStacksEqual(aFuel, new ItemStack(Items.field_179570_aq, 1))) {
            rFuelValue = Math.max(rFuelValue, 600);
    ...
    public void registerUnificationEntries() {
        ...
        for (OreDictEventContainer tOre : this.mEvents) {
            if ((!(tOre.mEvent.getOre().func_77973_b() instanceof GT_MetaGenerated_Item)) && (tOre.mPrefix != null) && (tOre.mPrefix.mIsUnificatable) && (tOre.mMaterial != null)) {
        ...
        for (OreDictEventContainer tOre : this.mEvents) {
            if (((tOre.mEvent.getOre().func_77973_b() instanceof GT_MetaGenerated_Item)) && (tOre.mPrefix != null) && (tOre.mPrefix.mIsUnificatable)
                    && (tOre.mMaterial != null)) {
                if (GT_OreDictUnificator.isBlacklisted(tOre.mEvent.getOre())) {
                    GT_OreDictUnificator.addAssociation(tOre.mPrefix, tOre.mMaterial, tOre.mEvent.getOre(), true);
                } else {
    ...
    {
        ChunkPos tPos = new ChunkPos(event.getChunk().field_76635_g, event.getChunk().field_76647_h);
        if(chunkData.containsKey(tPos)){
            int[] tInts = chunkData.get(tPos);
            if(tInts.length>0){event.getData().func_74768_a("GTOIL", tInts[0]);}
            if(tInts.length>1){event.getData().func_74768_a("GTPOLLUTION", tInts[1]);}}
    }
    ...
    public void handleChunkLoadEvent(ChunkDataEvent.Load event)
    {
        ...
        if(event.getData().func_74764_b("GTOIL")){
            if(tData.length>2){
                ...
                tOil += event.getData().func_74762_e("GTOIL");
            }
        }else{
            if(tData[0]!=0){
                tOil = tData[0];
        ...
        if(event.getData().func_74764_b("GTPOLLUTION")){
            if(tData.length>2){
                tPollution = tData[1];
            }else{
                tPollution += event.getData().func_74762_e("GTPOLLUTION");
            }
        }else{
            if(tData[1]!=0){
                tPollution = tData[1];
