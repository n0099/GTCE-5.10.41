...
public class GT_Client extends GT_Proxy
    ...
    static {
        ROTATABLE_VANILLA_BLOCKS = Arrays.asList(Blocks.field_150331_J, Blocks.field_150320_F, Blocks.field_150460_al, Blocks.field_150470_am,
                Blocks.field_150409_cd, Blocks.field_150367_z, Blocks.field_150486_ae, Blocks.field_150447_bR, Blocks.field_150477_bB, Blocks.field_150438_bZ,
    ...
    private static void drawGrid(DrawBlockHighlightEvent aEvent) {
        ...
        BlockPos pos = aEvent.getTarget().func_178782_a();
        GL11.glTranslated(-d0, -d1, -d2);
        GL11.glTranslated(pos.func_177958_n() + 0.5, pos.func_177956_o() + 0.5, pos.func_177952_p() + 0.5);
        Rotation.sideRotations[aEvent.getTarget().field_178784_b.func_176745_a()].glApply();
    ...
    public void onPostLoad() {
        ...
        map.get("default").func_177094_a(new GT_CapeRendererLayer(mCapeList, map.get("default")));
        map.get("slim").func_177094_a(new GT_CapeRendererLayer(mCapeList, map.get("slim")));
    }
    ...
    public void onDrawBlockHighlight(DrawBlockHighlightEvent aEvent) {
        if(aEvent.getPlayer() != null && aEvent.getTarget().field_72313_a == RayTraceResult.Type.BLOCK &&
                aEvent.getTarget().func_178782_a() != null) {
            EntityPlayer aPlayer = aEvent.getPlayer();
            ItemStack currentItem = aPlayer.func_184614_ca();
            BlockPos aPos = aEvent.getTarget().func_178782_a();
            Block block = aPlayer.field_70170_p.func_180495_p(aPos).func_177230_c();
            if (GT_Utility.isStackValid(currentItem)) {
                TileEntity aTileEntity = aPlayer.field_70170_p.func_175625_s(aPos);
                if (((aTileEntity instanceof BaseMetaPipeEntity)) && (((ICoverable) aTileEntity).getCoverIDAtSide((byte) aEvent.getTarget().field_178784_b.func_176745_a()) == 0) && ((GT_Utility.isStackInList(currentItem, GregTech_API.sCoverItems.keySet())) || (GT_Utility.isStackInList(currentItem, GregTech_API.sCrowbarList)) || (GT_Utility.isStackInList(currentItem, GregTech_API.sScrewdriverList)))) {
                    drawGrid(aEvent);
                }
