...
public abstract class GT_Tool
    ...
    public static final Enchantment[] FORTUNE_ENCHANTMENT = {Enchantment.func_180305_b("fortune")};
    public static final Enchantment[] LOOTING_ENCHANTMENT = {Enchantment.func_180305_b("looting")};
    ...
    protected static boolean isStateEqual(IBlockState state1, IBlockState state2) {
        if(state1.func_177230_c() != state2.func_177230_c())
            return false;
        if(!state1.func_177228_b().equals(state2.func_177228_b()))
            return false;
        return true;
    }
    ...
    public void onToolCrafted(ItemStack aStack, EntityPlayer aPlayer) {
        aPlayer.func_71029_a(AchievementList.field_187982_f);
        aPlayer.func_71029_a(AchievementList.field_187983_g);
        aPlayer.func_71029_a(AchievementList.field_187984_h);
    }
