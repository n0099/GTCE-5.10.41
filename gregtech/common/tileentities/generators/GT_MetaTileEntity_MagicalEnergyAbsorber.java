...
public class GT_MetaTileEntity_MagicalEnergyAbsorber extends GT_MetaTileEntity_BasicGenerator {
        ...
        if (aBaseMetaTileEntity.isServerSide() && aBaseMetaTileEntity.isAllowedToWork()
            ...
            if (hasEgg() && aTick % 10 == 0) {
                ...
                if ((mActiveSiphon != this) && (!sAllowMultipleEggs)) {
                    if ((mActiveSiphon == null) || (mActiveSiphon.getBaseMetaTileEntity() == null)
                        ...
                        if (!(tEgg == Blocks.field_150380_bt || tEgg.func_149739_a().equals("tile.dragonEgg"))) {
            ...
            if (sEnergyPerEnderCrystal > 0) {
                if (this.mTargetedCrystal == null) {
                    List<EntityEnderCrystal> tList = getBaseMetaTileEntity().getWorldObj().func_72872_a(
                    ...
                    this.mTargetedCrystal.func_184516_a(getBaseMetaTileEntity().getWorldPos());
    ...
    public boolean hasEgg() {
        ...
        return !(above == null || Blocks.field_150350_a == above) && (
                Blocks.field_150380_bt == above ||
                above.func_149739_a().equals("tile.dragonEgg"));
    }
