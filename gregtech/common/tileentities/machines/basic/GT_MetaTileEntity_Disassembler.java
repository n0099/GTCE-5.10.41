...
public class GT_MetaTileEntity_Disassembler
    ...
    public int checkRecipe() {
        if ((getInputAt(0) != null) && (isOutputEmpty())) {
            NBTTagCompound tNBT = getInputAt(0).func_77978_p();
            if (tNBT != null) {
                tNBT = tNBT.func_74775_l("GT.CraftingComponents");
                if (tNBT != null) {
    ...
    public boolean allowPutStack(IGregTechTileEntity aBaseMetaTileEntity, int aIndex, byte aSide, ItemStack aStack) {
        return (super.allowPutStack(aBaseMetaTileEntity, aIndex, aSide, aStack)) && (aStack.func_77978_p() != null) && (aStack.func_77978_p().func_74775_l("GT.CraftingComponents") != null);
    }
}
