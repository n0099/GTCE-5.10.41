...
public class GT_MetaTileEntity_PyrolyseOven extends GT_MetaTileEntity_MultiBlockBase {
    ...
    public boolean checkMachine(IGregTechTileEntity aBaseMetaTileEntity, ItemStack aStack) {
        int xDir = EnumFacing.field_82609_l[aBaseMetaTileEntity.getBackFacing()].func_82601_c() * 2;
        int zDir = EnumFacing.field_82609_l[aBaseMetaTileEntity.getBackFacing()].func_82599_e() * 2;
    ...
    private void replaceDeprecatedCoils(IGregTechTileEntity aBaseMetaTileEntity) {
        ...
        int zDir = EnumFacing.field_82609_l[aBaseMetaTileEntity.getBackFacing()].func_82601_c();
        ...
        for (int xPos = tX - 1; xPos <= tX + 1; xPos++) {
            for (int zPos = tZ - 1; zPos <= tZ + 1; zPos++) {
                ...
                {
                    aBaseMetaTileEntity.getWorldObj().func_180501_a(
                            new BlockPos(xPos, tY, zPos),
                            GregTech_API.sBlockCasings5.func_176203_a(1), 3);
                }
            }
        }
    }
