    ...
    int fluidIntoPower(ArrayList<FluidStack> aFluids, int aOptFlow, int aBaseEff) {
        ...
        for (int i = 0; i < aFluids.size() && remainingFlow > 0; i++) {
            ...
            if (fluidName.equals("ic2.fluidSuperheatedSteam")) {
                ...
                if (!achievement) {
                    GT_Mod.instance.achievements.issueAchievement(this.getBaseMetaTileEntity().getWorldObj().func_72924_a(this.getBaseMetaTileEntity().getOwnerName()), "efficientsteam");
                    achievement = true;
                }
