...
public class GT_MetaTileEntity_Macerator_Steel
    ...
    public void onPreTick(IGregTechTileEntity aBaseMetaTileEntity, long aTick) {
        ...
        if ((aBaseMetaTileEntity.isClientSide()) && (aBaseMetaTileEntity.isActive()) && (aBaseMetaTileEntity.getFrontFacing() != 1) && (aBaseMetaTileEntity.getCoverIDAtSide((byte) 1) == 0) && (!aBaseMetaTileEntity.getOpacityAtSide((byte) 1))) {
            ...
            aBaseMetaTileEntity.getWorldObj().func_175688_a(EnumParticleTypes.SMOKE_LARGE, aBaseMetaTileEntity.getXCoord() + 0.8F - tRandom.nextFloat() * 0.6F, aBaseMetaTileEntity.getYCoord() + 0.9F + tRandom.nextFloat() * 0.2F, aBaseMetaTileEntity.getZCoord() + 0.8F - tRandom.nextFloat() * 0.6F, 0.0D, 0.0D, 0.0D);
        }
    }
    ...
    public int checkRecipe() {
        ...
        getInputAt(0).field_77994_a -= tRecipe.mInputs[0].field_77994_a;
