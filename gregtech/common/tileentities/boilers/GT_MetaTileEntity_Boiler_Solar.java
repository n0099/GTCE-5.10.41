        ...
        if ((aBaseMetaTileEntity.isServerSide()) && (aTick > 20L)) {
            ...
            if (getFluidAmount() != 0) {
                for (EnumFacing side : EnumFacing.field_82609_l) {
                    if (side.func_176745_a() != aBaseMetaTileEntity.getFrontFacing() && side != EnumFacing.DOWN) {
            ...
            if ((this.mProcessingEnergy <= 0) && (aBaseMetaTileEntity.isAllowedToWork()) && (aTick % 256L == 0L) && (!aBaseMetaTileEntity.getWorldObj().func_72911_I())) {
                boolean bRain = aBaseMetaTileEntity.getWorldObj().func_72896_J() && aBaseMetaTileEntity.getBiome().func_76727_i() > 0.0F;
                mProcessingEnergy += bRain && aBaseMetaTileEntity.getWorldObj().func_175657_ab() >= 4 || !aBaseMetaTileEntity.getSkyAtSide((byte) 1) ? 0 : !bRain && aBaseMetaTileEntity.getWorldObj().func_72935_r() ? 8 : 1;
            }
