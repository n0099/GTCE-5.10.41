        ...
        for (int tX = cX; tX <= eX; tX++) {
            ...
            for (int tZ = cZ; tZ <= eZ; tZ++) {
                for (int i = tMinY + 3; i < tMinY + 6; i++) {
                    if ((aRandom.nextInt(Math.max(1, Math.max(MathHelper.func_76130_a(cZ - tZ), MathHelper.func_76130_a(eZ - tZ)) / this.mDensity)) == 0) || (aRandom.nextInt(Math.max(1, Math.max(MathHelper.func_76130_a(cX - tX), MathHelper.func_76130_a(eX - tX)) / this.mDensity)) == 0)) {
                        temp.func_181079_c(tX, i, tZ);
                ...
                if (this.mBetweenMeta > 0 && ((aRandom.nextInt(Math.max(1, Math.max(MathHelper.func_76130_a(cZ - tZ), MathHelper.func_76130_a(eZ - tZ)) / this.mDensity)) == 0) || (aRandom.nextInt(Math.max(1, Math.max(MathHelper.func_76130_a(cX - tX), MathHelper.func_76130_a(eX - tX)) / this.mDensity)) == 0))) {
                    temp.func_181079_c(tX, tMinY + 2 + aRandom.nextInt(2), tZ);
                    GT_Block_GeneratedOres.setOreBlock(aWorld, temp, this.mBetweenMeta, false);
                }
                if (this.mSporadicMeta > 0 && ((aRandom.nextInt(Math.max(1, Math.max(MathHelper.func_76130_a(cZ - tZ), MathHelper.func_76130_a(eZ - tZ)) / this.mDensity)) == 0) || (aRandom.nextInt(Math.max(1, Math.max(MathHelper.func_76130_a(cX - tX), MathHelper.func_76130_a(eX - tX)) / this.mDensity)) == 0))) {
                    temp.func_181079_c(tX, tMinY - 1 + aRandom.nextInt(7), tZ);
