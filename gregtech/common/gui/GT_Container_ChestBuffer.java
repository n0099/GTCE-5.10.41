...
public class GT_Container_ChestBuffer
    ...
    public void addSlots(InventoryPlayer aInventoryPlayer) {
        for (int y = 0; y < 3; y++) {
            for (int x = 0; x < 9; x++) {
                func_75146_a(new Slot(this.mTileEntity, x + y * 9, 8 + x * 18, 5 + y * 18));
            }
        }
        func_75146_a(new GT_Slot_Holo(this.mTileEntity, 27, 8, 63, false, true, 1));
        func_75146_a(new GT_Slot_Holo(this.mTileEntity, 27, 26, 63, false, true, 1));
        func_75146_a(new GT_Slot_Holo(this.mTileEntity, 27, 44, 63, false, true, 1));
    }
