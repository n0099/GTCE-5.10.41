...
public class GT_GUIContainer_QuantumChest extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void func_146979_b(int par1, int par2) {
        field_146289_q.func_78276_b(GT_LanguageManager.getTranslation("container.inventory"), 8, field_147000_g - 96 + 2, 4210752);
        field_146289_q.func_78276_b(mName, 8, 6, 4210752);
        if (mContainer != null) {
            field_146289_q.func_78276_b("Item Amount", 10, 20, 16448255);
            field_146289_q.func_78276_b(GT_Utility.parseNumberToString(((GT_Container_QuantumChest) mContainer).mContent), 10, 30, 16448255);
        }
    }
