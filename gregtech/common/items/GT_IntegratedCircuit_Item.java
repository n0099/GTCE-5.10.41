...
public class GT_IntegratedCircuit_Item extends GT_Generic_Item {
    ...
    public void addAdditionalToolTips(List<String> aList, ItemStack aStack, EntityPlayer aPlayer) {
        ...
        aList.add(GT_LanguageManager.addStringLocalization(new StringBuilder().append(func_77658_a()).append(".configuration").toString(), "Configuration: ") + getConfigurationString(getDamage(aStack)));
    }
