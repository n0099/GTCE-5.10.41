...
public abstract class MetaTileEntity implements IMetaTileEntity {
    ...
    public MetaTileEntity(int aID, String aBasicName, String aRegionalName, int aInvSlotCount) {
        ...
        if (GT.isClientSide()) {
            ...
            tStack.func_77973_b().func_77624_a(tStack, null, new ArrayList<String>(), true);
        }
    }
    ...
    public boolean onRightclick(IGregTechTileEntity aBaseMetaTileEntity, EntityPlayer aPlayer, byte aSide, float aX, float aY, float aZ, EnumHand hand) {
        return onRightclick(aBaseMetaTileEntity, aPlayer, hand);
    }
    ...
    protected static EnumFacing facing(byte value) {
        return EnumFacing.field_82609_l[value];
    }
