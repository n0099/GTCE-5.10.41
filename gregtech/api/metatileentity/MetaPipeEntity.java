...
public abstract class MetaPipeEntity implements IMetaTileEntity {
    ...
    public boolean isCoverOnSide(BaseMetaPipeEntity aPipe, EntityLivingBase aEntity) {
        byte aSide = 6;
        double difference = aEntity.field_70163_u - (double) aPipe.func_174877_v().func_177956_o();
        ...
        difference = aEntity.field_70161_v - (double) aPipe.func_174877_v().func_177952_p();
        ...
        difference = aEntity.field_70165_t - (double) aPipe.func_174877_v().func_177958_n();
        if (difference < -0.05 && difference > -0.4) {
            aSide = 4;
        }
        if (difference > 1.05 && difference < 1.4) {
    ...
    public ItemStack func_70298_a(int aIndex, int aAmount) {
        ItemStack tStack = func_70301_a(aIndex), rStack = GT_Utility.copy(tStack);
        if (tStack != null) {
            if (tStack.field_77994_a <= aAmount) {
                if (setStackToZeroInsteadOfNull(aIndex)) tStack.field_77994_a = 0;
                else func_70299_a(aIndex, null);
            } else {
                rStack = tStack.func_77979_a(aAmount);
                if (tStack.field_77994_a == 0 && !setStackToZeroInsteadOfNull(aIndex))
                    func_70299_a(aIndex, null);
            }
        }
        return rStack;
    }
    ...
    public int[] func_180463_a(EnumFacing aSide) {
        ...
        boolean tSkip = tTileEntity.getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsItemsIn((byte) aSide.func_176745_a(), tTileEntity.getCoverIDAtSide((byte) aSide.func_176745_a()), tTileEntity.getCoverDataAtSide((byte) aSide.func_176745_a()), -2, tTileEntity) || tTileEntity.getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsItemsOut((byte) aSide.func_176745_a(), tTileEntity.getCoverIDAtSide((byte) aSide.func_176745_a()), tTileEntity.getCoverDataAtSide((byte) aSide.func_176745_a()), -2, tTileEntity);
        for (int i = 0; i < func_70302_i_(); i++)
            if (isValidSlot(i) && (tSkip || tTileEntity.getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsItemsOut((byte) aSide.func_176745_a(), tTileEntity.getCoverIDAtSide((byte) aSide.func_176745_a()), tTileEntity.getCoverDataAtSide((byte) aSide.func_176745_a()), i, tTileEntity) || tTileEntity.getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsItemsIn((byte) aSide.func_176745_a(), tTileEntity.getCoverIDAtSide((byte) aSide.func_176745_a()), tTileEntity.getCoverDataAtSide((byte) aSide.func_176745_a()), i, tTileEntity)))
                tList.add(i);
    ...
    public boolean func_180462_a(int aIndex, ItemStack aStack, EnumFacing aSide) {
        return isValidSlot(aIndex) && aStack != null && aIndex < mInventory.length && (mInventory[aIndex] == null || GT_Utility.areStacksEqual(aStack, mInventory[aIndex])) && allowPutStack(getBaseMetaTileEntity(), aIndex, (byte) aSide.func_176745_a(), aStack);
    }

    @Override
    public boolean func_180461_b(int aIndex, ItemStack aStack, EnumFacing aSide) {
        return isValidSlot(aIndex) && aStack != null && aIndex < mInventory.length && allowPullStack(getBaseMetaTileEntity(), aIndex, (byte) aSide.func_176745_a(), aStack);
    }
    ...
    public void doExplosion(long aExplosionPower) {
        ...
        tWorld.func_175698_g(new BlockPos(tX, tY, tZ));
        if (GregTech_API.sMachineExplosions)
            tWorld.func_72876_a(null, tX + 0.5, tY + 0.5, tZ + 0.5, tStrength, true);
    }
    ...
    public void addCollisionBoxesToList(World aWorld, int aX, int aY, int aZ, AxisAlignedBB inputAABB, List<AxisAlignedBB> outputAABB, Entity collider) {
        ...
        if (axisalignedbb1 != null && inputAABB.func_72326_a(axisalignedbb1)) outputAABB.add(axisalignedbb1);
    }
