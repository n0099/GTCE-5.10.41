        ...
        if (aBaseMetaTileEntity.isServerSide()) {
            ...
            for (byte i = 0; i < 6 && aBaseMetaTileEntity.getStoredEU() < aBaseMetaTileEntity.getEUCapacity(); i++)
                if (aBaseMetaTileEntity.inputEnergyFrom(i)) {
                    ...
                    if (tTileEntity instanceof IEnergySource && ((IEnergySource) tTileEntity).emitsEnergyTo(aBaseMetaTileEntity, EnumFacing.field_82609_l[i].func_176734_d())) {
                        ...
                        aBaseMetaTileEntity.injectEnergyUnits((byte) 6, tEU, 1);
                    } else if (GregTech_API.mInputRF && tTileEntity instanceof IEnergyProvider && ((IEnergyProvider) tTileEntity).extractEnergy(EnumFacing.field_82609_l[i].func_176734_d(), 1, true) == 1) {
                        long tEU = (long) ((IEnergyProvider) tTileEntity).extractEnergy(EnumFacing.field_82609_l[i].func_176734_d(), (int) maxEUInput() * 100 / GregTech_API.mRFtoEU, false);
