...
public class GT_Runnable_Sound implements Runnable {
    ...
    public void run() {
        SoundEvent soundEvent = SoundEvent.field_187505_a.func_82594_a(mSoundLocation);
        if(soundEvent != null) {
            mWorld.func_184134_a((double)mX, (double)mY, (double)mZ, soundEvent, SoundCategory.BLOCKS, 1.0f, 1.0f, false);
        }
    }
