...
public class GregTech_API {
    ...
    public static void registerSound(int id, String name) {
        ...
        if(!SoundEvent.field_187505_a.func_148741_d(loc)) {
            SoundEvent.field_187505_a.func_177775_a(size++, loc, e);
        }
    ...
    public static ItemStack getUnificatedOreDictStack(ItemStack aOreStack) {
        if (!GregTech_API.sPreloadFinished)
            GT_Log.err.println("GregTech_API ERROR: " + aOreStack.func_77973_b() + "." + aOreStack.func_77952_i() + " - OreDict Unification Entries are not registered now, please call it in the postload phase.");
    ...
    public static GT_CoverBehavior getCoverBehavior(ItemStack aStack) {
        if (aStack == null || aStack.func_77973_b() == null) return sNoBehavior;
