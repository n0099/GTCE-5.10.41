...
public class GT_Utility {
    ...
    public static TextureAtlasSprite getTexture(String location) {
        return Minecraft.func_71410_x().func_147117_R().func_110572_b(location);
    }
    @SideOnly(Side.CLIENT)
    ...
    public static int fillFluidTank(World world, BlockPos blockPos, EnumFacing side, FluidStack fill) {
        TileEntity tileEntity = world.func_175625_s(blockPos.func_177972_a(side));
        if(tileEntity != null && fill != null) {
            if(tileEntity instanceof IFluidHandler) {
                IFluidHandler fluidHandler = (IFluidHandler) tileEntity;
                return fluidHandler.fill(side.func_176734_d(), fill, true);
            }
            if(tileEntity.hasCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, side.func_176734_d())) {
                net.minecraftforge.fluids.capability.IFluidHandler fluidHandler = tileEntity.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, side.func_176734_d());
    ...
    public static boolean getFullInvisibility(EntityPlayer aPlayer) {
        try {
            if (aPlayer.func_82150_aj()) {
                for (int i = 0; i < 4; i++) {
                    if (aPlayer.field_71071_by.field_70460_b[i] != null) {
    ...
    public static ItemStack suckOneItemStackAt(World aWorld, double aX, double aY, double aZ, double aL, double aH, double aW) {
        for (EntityItem tItem : aWorld.func_72872_a(EntityItem.class, new AxisAlignedBB(aX, aY, aZ, aX + aL, aY + aH, aZ + aW))) {
            if (!tItem.field_70128_L) {
    ...
    public static byte getOppositeSide(int aSide) {
        return (byte) EnumFacing.field_82609_l[aSide].func_176734_d().func_176745_a();
    }
    ...
    public static void sendChatToPlayer(EntityPlayer aPlayer, String aChatMessage) {
        if (aPlayer instanceof EntityPlayerMP && aChatMessage != null) {
            aPlayer.func_146105_b(new TextComponentString(aChatMessage));
        }
    }
    ...
    */
    public static byte moveStackIntoPipe(IInventory aTileEntity1, Object aTileEntity2, int[] aGrabSlots, int aGrabFrom, int aPutTo, List<ItemStack> aFilter, boolean aInvertFilter, byte aMaxTargetStackSize, byte aMinTargetStackSize, byte aMaxMoveAtOnce, byte aMinMoveAtOnce, boolean dropItem) {
        ...
        EnumFacing tDirection = EnumFacing.field_82609_l[aGrabFrom];
        if (aTileEntity1 instanceof TileEntity && tDirection != null && tDirection.func_176734_d() == EnumFacing.field_82609_l[aPutTo]) {
            int tX = ((TileEntity) aTileEntity1).func_174877_v().func_177958_n() + tDirection.func_82601_c(), tY = ((TileEntity) aTileEntity1).func_174877_v().func_177956_o() + tDirection.func_96559_d(), tZ = ((TileEntity) aTileEntity1).func_174877_v().func_177952_p() + tDirection.func_82599_e();
            if (!hasBlockHitBox(((TileEntity) aTileEntity1).func_145831_w(), ((TileEntity) aTileEntity1).func_174877_v()) && dropItem) {
                for (int aGrabSlot : aGrabSlots) {
                    if (listContainsItem(aFilter, aTileEntity1.func_70301_a(aGrabSlot), true, aInvertFilter)) {
                        if (isAllowedToTakeFromSlot(aTileEntity1, aGrabSlot, (byte) aGrabFrom, aTileEntity1.func_70301_a(aGrabSlot))) {
                            if (Math.max(aMinMoveAtOnce, aMinTargetStackSize) <= aTileEntity1.func_70301_a(aGrabSlot).field_77994_a) {
                                ItemStack tStack = copyAmount(Math.min(aTileEntity1.func_70301_a(aGrabSlot).field_77994_a, Math.min(aMaxMoveAtOnce, aMaxTargetStackSize)), aTileEntity1.func_70301_a(aGrabSlot));
                                EntityItem tEntity = new EntityItem(((TileEntity) aTileEntity1).func_145831_w(), tX + 0.5, tY + 0.5, tZ + 0.5, tStack);
                                tEntity.field_70159_w = tEntity.field_70181_x = tEntity.field_70179_y = 0;
                                ((TileEntity) aTileEntity1).func_145831_w().func_72838_d(tEntity);
                                aTileEntity1.func_70298_a(aGrabSlot, tStack.field_77994_a);
    ...
    public static byte moveStackFromSlotAToSlotB(IInventory aTileEntity1, IInventory aTileEntity2, int aGrabFrom, int aPutTo, byte aMaxTargetStackSize, byte aMinTargetStackSize, byte aMaxMoveAtOnce, byte aMinMoveAtOnce) {
        ...
        ItemStack tStack1 = aTileEntity1.func_70301_a(aGrabFrom), tStack2 = aTileEntity2.func_70301_a(aPutTo), tStack3 = null;
        if (tStack1 != null) {
            ...
            if (tStack3.field_77994_a > aMaxMoveAtOnce) tStack3.field_77994_a = aMaxMoveAtOnce;
            if (tStack3.field_77994_a + (tStack2 == null ? 0 : tStack2.field_77994_a) >= Math.min(tStack3.func_77976_d(), aMinTargetStackSize) && tStack3.field_77994_a >= aMinMoveAtOnce) {
                ...
                if (tStack3 != null) {
                    if (tStack2 == null) {
                        aTileEntity2.func_70299_a(aPutTo, copy(tStack3));
    ...
    public static boolean isAllowedToTakeFromSlot(IInventory aTileEntity, int aSlot, byte aSide, ItemStack aStack) {
        ...
        return !(aTileEntity instanceof ISidedInventory) || ((ISidedInventory) aTileEntity).func_180461_b(aSlot, aStack, EnumFacing.field_82609_l[aSide]);
    }
    ...
    public static boolean isAllowedToPutIntoSlot(IInventory aTileEntity, int aSlot, byte aSide, ItemStack aStack, byte aMaxStackSize) {
        ...
        if (tStack != null && (!areStacksEqual(tStack, aStack) || tStack.field_77994_a >= tStack.func_77976_d()))
            return false;
        if (aSide > 6) {
        ...
        return !(aTileEntity instanceof ISidedInventory && !((ISidedInventory) aTileEntity).func_180462_a(aSlot, aStack, EnumFacing.field_82609_l[aSide])) && aTileEntity.func_94041_b(aSlot, aStack);
    }
    ...
    private static byte moveOneItemStack(IInventory aTileEntity1, Object aTileEntity2, byte aGrabFrom, byte aPutTo, List<ItemStack> aFilter, boolean aInvertFilter, byte aMaxTargetStackSize, byte aMinTargetStackSize, byte aMaxMoveAtOnce, byte aMinMoveAtOnce, boolean aDoCheckChests) {
        ...
        if (aTileEntity1 instanceof ISidedInventory)
            tGrabSlots = ((ISidedInventory) aTileEntity1).func_180463_a(EnumFacing.field_82609_l[aGrabFrom]);
        if (tGrabSlots == null) {
        ...
        if (aTileEntity2 instanceof IInventory) {
            ...
            if (aTileEntity2 instanceof ISidedInventory)
                tPutSlots = ((ISidedInventory) aTileEntity2).func_180463_a(EnumFacing.field_82609_l[aPutTo]);
            ...
            for (int i = 0; i < tGrabSlots.length; i++) {
                ...
                for (int j = 0; j < tPutSlots.length; j++) {
                    if (listContainsItem(aFilter, aTileEntity1.func_70301_a(tGrabSlots[i]), true, aInvertFilter)) {
                        if (isAllowedToTakeFromSlot(aTileEntity1, tGrabSlots[i], aGrabFrom, aTileEntity1.func_70301_a(tGrabSlots[i]))) {
                            if (isAllowedToPutIntoSlot((IInventory) aTileEntity2, tPutSlots[j], aPutTo, aTileEntity1.func_70301_a(tGrabSlots[i]), aMaxTargetStackSize)) {
            ...
            if (aDoCheckChests && aTileEntity1 instanceof TileEntityChest) {
                ...
                if (tTileEntity1.field_145984_a) {
                    ...
                    if (tTileEntity1.field_145991_k != null) {
                        tAmount = moveOneItemStack(tTileEntity1.field_145991_k, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false);
                    } else if (tTileEntity1.field_145992_i != null) {
                        tAmount = moveOneItemStack(tTileEntity1.field_145992_i, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false);
                    } else if (tTileEntity1.field_145990_j != null) {
                        tAmount = moveOneItemStack(tTileEntity1.field_145990_j, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false);
                    } else if (tTileEntity1.field_145988_l != null) {
                        tAmount = moveOneItemStack(tTileEntity1.field_145988_l, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false);
                    }
            ...
            if (aDoCheckChests && aTileEntity2 instanceof TileEntityChest) {
                ...
                if (tTileEntity2.field_145984_a) {
                    ...
                    if (tTileEntity2.field_145991_k != null) {
                        tAmount = moveOneItemStack(aTileEntity1, tTileEntity2.field_145991_k, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false);
                    } else if (tTileEntity2.field_145992_i != null) {
                        tAmount = moveOneItemStack(aTileEntity1, tTileEntity2.field_145992_i, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false);
                    } else if (tTileEntity2.field_145990_j != null) {
                        tAmount = moveOneItemStack(aTileEntity1, tTileEntity2.field_145990_j, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false);
                    } else if (tTileEntity2.field_145988_l != null) {
                        tAmount = moveOneItemStack(aTileEntity1, tTileEntity2.field_145988_l, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false);
                    }
                    if (tAmount != 0) return tAmount;
                }
            }
    ...
    public static byte moveOneItemStackIntoSlot(Object aTileEntity1, Object aTileEntity2, byte aGrabFrom, int aPutTo, List<ItemStack> aFilter, boolean aInvertFilter, byte aMaxTargetStackSize, byte aMinTargetStackSize, byte aMaxMoveAtOnce, byte aMinMoveAtOnce) {
        ...
        if (aTileEntity2 != null && aTileEntity2 instanceof IInventory) {
            for (int i = 0; i < tGrabSlots.length; i++) {
                if (listContainsItem(aFilter, ((IInventory) aTileEntity1).func_70301_a(tGrabSlots[i]), true, aInvertFilter)) {
                    if (isAllowedToTakeFromSlot((IInventory) aTileEntity1, tGrabSlots[i], aGrabFrom, ((IInventory) aTileEntity1).func_70301_a(tGrabSlots[i]))) {
                        if (isAllowedToPutIntoSlot((IInventory) aTileEntity2, aPutTo, (byte) 6, ((IInventory) aTileEntity1).func_70301_a(tGrabSlots[i]), aMaxTargetStackSize)) {
    ...
    public static byte moveFromSlotToSlot(IInventory aTileEntity1, IInventory aTileEntity2, int aGrabFrom, int aPutTo, List<ItemStack> aFilter, boolean aInvertFilter, byte aMaxTargetStackSize, byte aMinTargetStackSize, byte aMaxMoveAtOnce, byte aMinMoveAtOnce) {
        if (aTileEntity1 == null || aTileEntity2 == null || aGrabFrom < 0 || aPutTo < 0 || aMaxTargetStackSize <= 0 || aMinTargetStackSize <= 0 || aMaxMoveAtOnce <= 0 || aMinTargetStackSize > aMaxTargetStackSize || aMinMoveAtOnce > aMaxMoveAtOnce)
            return 0;
        if (listContainsItem(aFilter, aTileEntity1.func_70301_a(aGrabFrom), true, aInvertFilter)) {
            if (isAllowedToTakeFromSlot(aTileEntity1, aGrabFrom, (byte) 6, aTileEntity1.func_70301_a(aGrabFrom))) {
                if (isAllowedToPutIntoSlot(aTileEntity2, aPutTo, (byte) 6, aTileEntity1.func_70301_a(aGrabFrom), aMaxTargetStackSize)) {
    ...
    public static boolean listContainsItem(Collection<ItemStack> aList, ItemStack aStack, boolean aTIfListEmpty, boolean aInvertFilter) {
        if (aStack == null || aStack.field_77994_a < 1) return false;
    ...
    public static boolean areStacksOrToolsEqual(ItemStack aStack1, ItemStack aStack2) {
        if (aStack1 != null && aStack2 != null && aStack1.func_77973_b() == aStack2.func_77973_b()) {
            if (aStack1.func_77973_b().func_77645_m()) return true;
            return ((aStack1.func_77978_p() == null) == (aStack2.func_77978_p() == null)) && (aStack1.func_77978_p() == null || aStack1.func_77978_p().equals(aStack2.func_77978_p())) && (Items.field_151008_G.getDamage(aStack1) == Items.field_151008_G.getDamage(aStack2) || Items.field_151008_G.getDamage(aStack1) == W || Items.field_151008_G.getDamage(aStack2) == W);
        }
        return false;
    }
    ...
    public static ItemStack fillFluidContainer(FluidStack aFluid, ItemStack aStack, boolean aRemoveFluidDirectly, boolean aCheckIFluidContainerItems) {
        ...
        if (GT_ModHandler.isWater(aFluid) && ItemList.Bottle_Empty.isStackEqual(aStack)) {
            if (aFluid.amount >= 250) {
                ...
                return new ItemStack(Items.field_151068_bn, 1, 0);
            }
            return null;
        }
        if (aCheckIFluidContainerItems && aStack.func_77973_b() instanceof IFluidContainerItem && ((IFluidContainerItem) aStack.func_77973_b()).getFluid(aStack) == null && ((IFluidContainerItem) aStack.func_77973_b()).getCapacity(aStack) <= aFluid.amount) {
            if (aRemoveFluidDirectly)
                aFluid.amount -= ((IFluidContainerItem) aStack.func_77973_b()).fill(aStack = copyAmount(1, aStack), aFluid, true);
            else
                ((IFluidContainerItem) aStack.func_77973_b()).fill(aStack = copyAmount(1, aStack), aFluid, true);
            return aStack;
        }
    ...
    public static ItemStack getFluidDisplayStack(FluidStack aFluid, boolean aUseStackSize) {
        ...
        tNBT.func_74772_a("mFluidDisplayAmount", aFluid.amount);
        tNBT.func_74772_a("mFluidDisplayHeat", aFluid.getFluid().getTemperature(aFluid));
    ...
    public static boolean containsFluid(ItemStack aStack, FluidStack aFluid, boolean aCheckIFluidContainerItems) {
        ...
        if (aCheckIFluidContainerItems && aStack.func_77973_b() instanceof IFluidContainerItem) {
            IFluidContainerItem containerItem = (IFluidContainerItem) aStack.func_77973_b();
    ...
    public static FluidStack getFluidForFilledItem(ItemStack aStack, boolean aCheckIFluidContainerItems) {
        ...
        if (aCheckIFluidContainerItems && aStack.func_77973_b() instanceof IFluidContainerItem && ((IFluidContainerItem) aStack.func_77973_b()).getCapacity(aStack) > 0)
            return ((IFluidContainerItem) aStack.func_77973_b()).drain(copyAmount(1, aStack), Integer.MAX_VALUE, true);
        FluidContainerData tData = sFilledContainerToData.get(new GT_ItemStack(aStack));
    ...
    public static ItemStack getContainerForFilledItem(ItemStack aStack, boolean aCheckIFluidContainerItems) {
        ...
        if (aCheckIFluidContainerItems && aStack.func_77973_b() instanceof IFluidContainerItem && ((IFluidContainerItem) aStack.func_77973_b()).getCapacity(aStack) > 0) {
            ((IFluidContainerItem) aStack.func_77973_b()).drain(aStack = copyAmount(1, aStack), Integer.MAX_VALUE, true);
            return aStack;
        }
        return null;
    }
    ...
    public static ItemStack getContainerItem(ItemStack aStack, boolean aCheckIFluidContainerItems) {
        if (isStackInvalid(aStack)) return null;
        if (aStack.func_77973_b().hasContainerItem(aStack)) return aStack.func_77973_b().getContainerItem(aStack);
        ...
        if (ItemList.IC2_ForgeHammer.isStackEqual(aStack) || ItemList.IC2_WireCutter.isStackEqual(aStack))
            return copyMetaData(Items.field_151008_G.getDamage(aStack) + 1, aStack);
        return null;
    }
    ...
    public static boolean addSimpleIC2MachineRecipe(ItemStack aInput, IMachineRecipeManager aRecipeList, NBTTagCompound aNBT, Object... aOutput) {
        ...
        if (tOreName != null) {
            ...
            if(tOreName.toString().equals("dustAsh")&&tStack[0].func_77977_a().equals("tile.volcanicAsh"))return false;
            aRecipeList.addRecipe(new RecipeInputOreDict(tOreName.toString(), aInput.field_77994_a), aNBT, true, tStack);
        } else {
            aRecipeList.addRecipe(new RecipeInputItemStack(copy(aInput), aInput.field_77994_a), aNBT, true, tStack);
        }
        return true;
    }
    ...
    public static ItemStack getWrittenBook(String aMapping, String aTitle, String aAuthor, String... aPages) {
        ...
        for (byte i = 0; i < aPages.length; i++) {
            ...
            if (i < 48) {
                if (aPages[i].length() < 256)
                    tNBTList.func_74742_a(new NBTTagString(aPages[i]));
                else
        ...
        tNBTList.func_74742_a(new NBTTagString("Credits to " + aAuthor + " for writing this Book. This was Book Nr. " + sBookCount + " at its creation. Gotta get 'em all!"));
    ...
    public static boolean doSoundAtClient(String aSoundName, int aTimeUntilNextSound, float aSoundStrength, Entity aEntity) {
        ...
        return doSoundAtClient(aSoundName, aTimeUntilNextSound, aSoundStrength, aEntity.field_70165_t, aEntity.field_70163_u, aEntity.field_70161_v);
    }
    ...
    public static boolean doSoundAtClient(String aSoundName, int aTimeUntilNextSound, float aSoundStrength, BlockPos pos) {
        return doSoundAtClient(aSoundName, aTimeUntilNextSound, aSoundStrength, 1.01818028F, pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
    }
    ...
    public static boolean doSoundAtClient(String aSoundName, int aTimeUntilNextSound, float aSoundStrength, float aSoundModulation, double aX, double aY, double aZ) {
        if (isStringInvalid(aSoundName) || !FMLCommonHandler.instance().getEffectiveSide().isClient() || GT.getThePlayer() == null || !GT.getThePlayer().field_70170_p.field_72995_K)
            return false;
        new GT_Runnable_Sound(GT.getThePlayer().field_70170_p, MathHelper.func_76128_c(aX), MathHelper.func_76128_c(aY), MathHelper.func_76128_c(aZ), aTimeUntilNextSound, aSoundName, aSoundStrength, aSoundModulation).run();
        return true;
    }
    ...
    public static boolean sendSoundToPlayers(World aWorld, String aSoundName, float aSoundStrength, float aSoundModulation, int aX, int aY, int aZ) {
        if (isStringInvalid(aSoundName) || aWorld == null || aWorld.field_72995_K) return false;
    ...
    public static boolean sendSoundToPlayers(World aWorld, String aSoundName, float aSoundStrength, float aSoundModulation, BlockPos blockPos) {
        return sendSoundToPlayers(aWorld, aSoundName, aSoundStrength, aSoundModulation, blockPos.func_177958_n(), blockPos.func_177956_o(), blockPos.func_177952_p());
    }


    public static int stackToIntHash(ItemStack aStack) {
        if (isStackInvalid(aStack)) return 0;
        return Item.func_150891_b(aStack.func_77973_b()) | (Items.field_151008_G.getDamage(aStack) << 16);
    }
    ...
    public static Block getBlockFromStack(Object aStack) {
        if (isStackInvalid(aStack)) return null;
        return Block.func_149634_a(((ItemStack) aStack).func_77973_b());
    }
    ...
    public static ItemStack updateItemStack(ItemStack aStack) {
        if (isStackValid(aStack) && aStack.func_77973_b() instanceof GT_Generic_Item)
    ...
    public static boolean isOpaqueBlock(World aWorld, int aX, int aY, int aZ) {
        return aWorld.func_180495_p(new BlockPos(aX, aY, aZ)).func_185914_p();
    }

    public static boolean isOpaqueBlock(World aWorld, BlockPos blockPos) {
        return aWorld.func_180495_p(blockPos).func_185914_p();
    }

    public static boolean isBlockAir(World aWorld, int aX, int aY, int aZ) {
        return aWorld.func_175623_d(new BlockPos(aX, aY, aZ));
    }

    public static boolean hasBlockHitBox(World aWorld, BlockPos blockPos) {
        AxisAlignedBB box = aWorld.func_180495_p(blockPos).func_185890_d(aWorld, blockPos);
        return box != null && (box.field_72336_d != box.field_72340_a && box.field_72334_f != box.field_72339_c && box.field_72337_e != box.field_72338_b);
    }
    ...
    public static void setCoordsOnFire(World aWorld, int aX, int aY, int aZ, boolean aReplaceCenter) {
        ...
        if (aReplaceCenter)
            if (aWorld.func_180495_p(blockPos).func_185890_d(aWorld, blockPos) == null)
                aWorld.func_175656_a(blockPos, Blocks.field_150480_ab.func_176223_P());
        if (aWorld.func_180495_p(blockPos.func_177974_f()).func_185890_d(aWorld, blockPos.func_177974_f()) == null)
            aWorld.func_175656_a(blockPos.func_177974_f(), Blocks.field_150480_ab.func_176223_P());
        if (aWorld.func_180495_p(blockPos.func_177968_d()).func_185890_d(aWorld, blockPos.func_177968_d()) == null)
            aWorld.func_175656_a(blockPos.func_177968_d(), Blocks.field_150480_ab.func_176223_P());
        if (aWorld.func_180495_p(blockPos.func_177976_e()).func_185890_d(aWorld, blockPos.func_177976_e()) == null)
            aWorld.func_175656_a(blockPos.func_177976_e(), Blocks.field_150480_ab.func_176223_P());
        if (aWorld.func_180495_p(blockPos.func_177978_c()).func_185890_d(aWorld, blockPos.func_177978_c()) == null)
            aWorld.func_175656_a(blockPos.func_177978_c(), Blocks.field_150480_ab.func_176223_P());
        if (aWorld.func_180495_p(blockPos.func_177984_a()).func_185890_d(aWorld, blockPos.func_177984_a()) == null)
            aWorld.func_175656_a(blockPos.func_177984_a(), Blocks.field_150480_ab.func_176223_P());
        if (aWorld.func_180495_p(blockPos.func_177977_b()).func_185890_d(aWorld, blockPos.func_177977_b()) == null)
            aWorld.func_175656_a(blockPos.func_177977_b(), Blocks.field_150480_ab.func_176223_P());
    }

    public static ItemStack getProjectile(SubTag aProjectileType, IInventory aInventory) {
        if (aInventory != null) for (int i = 0, j = aInventory.func_70302_i_(); i < j; i++) {
            ItemStack rStack = aInventory.func_70301_a(i);
            if (isStackValid(rStack) && rStack.func_77973_b() instanceof IProjectileItem && ((IProjectileItem) rStack.func_77973_b()).hasProjectile(aProjectileType, rStack))
    ...
    public static void removeNullStacksFromInventory(IInventory aInventory) {
        if (aInventory != null) for (int i = 0, j = aInventory.func_70302_i_(); i < j; i++) {
            ...
            if (tStack != null && (tStack.field_77994_a == 0 || tStack.func_77973_b() == null))
    ...
    public static boolean isWearingFullFrostHazmat(EntityLivingBase aEntity) {
        for (EntityEquipmentSlot i : EntityEquipmentSlot.values())
            if (!isStackInList(aEntity.func_184582_a(i), GregTech_API.sFrostHazmatList)) return false;
        return true;
    }

    public static boolean isWearingFullHeatHazmat(EntityLivingBase aEntity) {
        for (EntityEquipmentSlot i : EntityEquipmentSlot.values())
            if (!isStackInList(aEntity.func_184582_a(i), GregTech_API.sHeatHazmatList)) return false;
        return true;
    }

    public static boolean isWearingFullBioHazmat(EntityLivingBase aEntity) {
        for (EntityEquipmentSlot i : EntityEquipmentSlot.values())
            if (!isStackInList(aEntity.func_184582_a(i), GregTech_API.sBioHazmatList)) return false;
        return true;
    }

    public static boolean isWearingFullRadioHazmat(EntityLivingBase aEntity) {
        for (EntityEquipmentSlot i : EntityEquipmentSlot.values())
            if (!isStackInList(aEntity.func_184582_a(i), GregTech_API.sRadioHazmatList)) return false;
        return true;
    }

    public static boolean isWearingFullElectroHazmat(EntityLivingBase aEntity) {
        for (EntityEquipmentSlot i : EntityEquipmentSlot.values())
            if (!isStackInList(aEntity.func_184582_a(i), GregTech_API.sElectroHazmatList)) return false;
        return true;
    }

    public static boolean isWearingFullGasHazmat(EntityLivingBase aEntity) {
        for (EntityEquipmentSlot i : EntityEquipmentSlot.values())
            if (!isStackInList(aEntity.func_184582_a(i), GregTech_API.sGasHazmatList)) return false;
        return true;
    }
    ...
    public static int getRadioactivityLevel(ItemStack aStack) {
        ...
        return EnchantmentHelper.func_77506_a(Enchantment_Radioactivity.INSTANCE, aStack);
    }
    ...
    public static boolean applyHeatDamage(EntityLivingBase aEntity, float aDamage) {
        if (aDamage > 0 && aEntity != null && aEntity.func_70660_b(MobEffects.field_76426_n) == null && !isWearingFullHeatHazmat(aEntity)) {
    ...
    public static boolean applyElectricityDamage(EntityLivingBase aEntity, long aVoltage, long aAmperage) {
        ...
        if (aDamage > 0 && aEntity != null && !isWearingFullElectroHazmat(aEntity)) {
            aEntity.func_70097_a(GT_DamageSources.getElectricDamage(), aDamage);
            return true;
        }
        return false;
    }
    ...
    public static boolean applyRadioactivity(EntityLivingBase aEntity, int aLevel, int aAmountOfItems) {
        if (aLevel > 0 && aEntity != null && aEntity.func_70668_bt() != EnumCreatureAttribute.UNDEAD && aEntity.func_70668_bt() != EnumCreatureAttribute.ARTHROPOD && !isWearingFullRadioHazmat(aEntity)) {
            aEntity.func_70690_d(new PotionEffect(MobEffects.field_76421_d, aLevel * 140 * aAmountOfItems));
            aEntity.func_70690_d(new PotionEffect(MobEffects.field_76431_k, aLevel * 130 * aAmountOfItems));
            aEntity.func_70690_d(new PotionEffect(MobEffects.field_76437_t, aLevel * 150 * aAmountOfItems));
            aEntity.func_70690_d(new PotionEffect(MobEffects.field_76438_s, aLevel * 130 * aAmountOfItems));
            aEntity.func_70690_d(new PotionEffect(IC2Potion.radiation, aLevel * 180 * aAmountOfItems));
            return true;
        }
        return false;
    }
    ...
    public static ItemStack copy(Object... aStacks) {
        for (Object tStack : aStacks)
            if (isStackValid(tStack)) return ((ItemStack) tStack).func_77946_l();
        return null;
    }
    ...
    public static ItemStack copyMetaData(long aMetaData, Object... aStacks) {
        ItemStack rStack = copy(aStacks);
        if (isStackInvalid(rStack)) return null;
        Items.field_151008_G.setDamage(rStack, (short) aMetaData);
        return rStack;
    }
    ...
    public static ItemStack loadItem(NBTTagCompound aNBT, String aTagName) {
        return loadItem(aNBT.func_74775_l(aTagName));
    }

    public static FluidStack loadFluid(NBTTagCompound aNBT, String aTagName) {
        return loadFluid(aNBT.func_74775_l(aTagName));
    }
    ...
    public static ItemStack loadItem(NBTTagCompound aNBT) {
        ...
        try {
            if (rStack != null && (rStack.func_77973_b().getClass().getName().startsWith("ic2.core.migration"))) {
                rStack.func_77973_b().func_77663_a(rStack, DW, null, 0, false);
            }
        } catch (Throwable e) {
    ...
    public static boolean moveEntityToDimensionAtCoords(Entity aEntity, int aDimension, double aX, double aY, double aZ) {
        WorldServer tTargetWorld = DimensionManager.getWorld(aDimension), tOriginalWorld = DimensionManager.getWorld(aEntity.field_70170_p.field_73011_w.getDimension());
...
//                FMLCommonHandler.instance().firePlayerChangedDimensionEvent(aPlayer, tOriginalWorld.provider.getDimension(), aDimension);
                aPlayer.func_184204_a(aDimension);
                ...
                Entity tNewEntity = EntityList.func_75620_a(EntityList.func_75621_b(aEntity), tTargetWorld);
                if (tNewEntity != null) {

                    NBTTagCompound nbttagcompound = aEntity.func_189511_e(new NBTTagCompound());
                    nbttagcompound.func_82580_o("Dimension");
                    tNewEntity.func_70020_e(nbttagcompound);
                    tNewEntity.field_71088_bW = aEntity.field_71088_bW;
    ...
    public static FluidStack getUndergroundOil(World aWorld, int aX, int aZ) {
        ...
        Random tRandom = new Random((aWorld.func_72905_C() + (aX / 96) + (7 * (aZ / 96))));
...
//		amount = 40;
    ...
    public static int getCoordinateScan(ArrayList<String> aList, EntityPlayer aPlayer, World aWorld, int aScanLevel, BlockPos blockPos, EnumFacing aSide, float aClickX, float aClickY, float aClickZ) {
        ...
        IBlockState tBlock = aWorld.func_180495_p(blockPos);

        tList.add("----- X: " + blockPos.func_177958_n() + " Y: " + blockPos.func_177956_o() + " Z: " + blockPos.func_177952_p() + " -----");
        try {
            if (tTileEntity instanceof IInventory)
                tList.add("Name: " + ((IInventory) tTileEntity).func_70005_c_() + "  MetaData: " + aWorld.func_180495_p(blockPos));
            else
                tList.add("Name: " + tBlock.func_177230_c().func_149739_a() + "  MetaData: " + tBlock.func_177230_c().func_176201_c(tBlock));
            ...
            if (tBlock.func_177230_c().isBeaconBase(aWorld, blockPos, blockPos.func_177982_a(0, 1, 0))) tList.add("Is valid Beacon Pyramid Material");
        } catch (Throwable e) {
            if (D1) e.printStackTrace(GT_Log.err);
        }
        if (tTileEntity != null) {
            ...
            try {
                if (tTileEntity instanceof ic2.api.tile.IWrenchable) {
                    rEUAmount += 100;
                    tList.add("Facing: " + ((ic2.api.tile.IWrenchable) tTileEntity).getFacing(tTileEntity.func_145831_w(), blockPos));
                    tList.add(((ic2.api.tile.IWrenchable) tTileEntity).wrenchCanRemove(tTileEntity.func_145831_w(), blockPos, aPlayer) ? "You can remove this with a Wrench" : "You can NOT remove this with a Wrench");
                }
            } catch (Throwable e) {
                if (D1) e.printStackTrace(GT_Log.err);
            }
            ...
            try {
                if (tTileEntity instanceof ICoverable) {
                    rEUAmount += 300;
                    String tString = ((ICoverable) tTileEntity).getCoverBehaviorAtSide((byte) aSide.func_176745_a()).getDescription((byte) aSide.func_176745_a(), ((ICoverable) tTileEntity).getCoverIDAtSide((byte) aSide.func_176745_a()), ((ICoverable) tTileEntity).getCoverDataAtSide((byte) aSide.func_176745_a()), (ICoverable) tTileEntity);
            ...
            try {
                if (tTileEntity instanceof ic2.api.crops.ICropTile) {
                    ...
                    if (cropTile.getCrop() != null) {
                        ...
                        tList.add("Type -- Crop-Name: " + I18n.func_74838_a(cropTile.getCrop().getUnlocalizedName())
        ...
        if (aPlayer.field_71075_bZ.field_75098_d&&GT_Values.D1) {
            FluidStack tFluid = getUndergroundOil(aWorld, blockPos.func_177958_n(), blockPos.func_177956_o());
            tList.add("Oil in Chunk: " + tFluid.amount + " " + tFluid.getLocalizedName());
        }
        //if(aPlayer.capabilities.isCreativeMode){
        ChunkPos pos = new ChunkPos(blockPos.func_177958_n() / 16, blockPos.func_177952_p() / 16);
        ...
        try {
            if (tBlock instanceof IDebugableBlock) {
                rEUAmount += 500;
                ArrayList<String> temp = ((IDebugableBlock) tBlock).getDebugInfo(aPlayer, blockPos.func_177958_n(), blockPos.func_177956_o(), blockPos.func_177952_p(), 3);
        ...
        BlockScanningEvent tEvent = new BlockScanningEvent(aWorld, aPlayer, blockPos.func_177958_n(), blockPos.func_177956_o(), blockPos.func_177952_p(), (byte) aSide.func_176745_a(), aScanLevel, tBlock.func_177230_c(), tTileEntity, tList, aClickX, aClickY, aClickZ);
    ...
    public static class ItemNBT {
        public static void setNBT(ItemStack aStack, NBTTagCompound aNBT) {
            ...
            for (Object tKey : aNBT.func_150296_c()) {
                NBTBase tValue = aNBT.func_74781_a((String) tKey);
                if (tValue == null || (tValue instanceof NBTPrimitive && ((NBTPrimitive) tValue).func_150287_d() == 0) || (tValue instanceof NBTTagString && isStringInvalid(((NBTTagString) tValue).func_150285_a_())))
                    tTagsToRemove.add((String) tKey);
            }
            for (Object tKey : tTagsToRemove) aNBT.func_82580_o((String) tKey);
        ...
        public static short getMapID(ItemStack aStack) {
            NBTTagCompound tNBT = getNBT(aStack);
            if (!tNBT.func_74764_b("map_id")) return -1;
        ...
        public static void setProspectionData(ItemStack aStack, int aX, int aY, int aZ, int aDim, FluidStack aFluid, String[] aOres) {
            ...
            tNBT.func_74778_a("prospection", tData);
            setNBT(aStack, tNBT);
        }
        ...
        public static void convertProspectionData(ItemStack aStack) {
            ...
            if (tDataArray.length > 6) {
                tNBT.func_74778_a("author", "X: " + tDataArray[0] + " Y: " + tDataArray[1] + " Z: " + tDataArray[2] + " Dim: " + tDataArray[3]);
                NBTTagList tNBTList = new NBTTagList();
                String tOres = " Prospected Ores: ";
                for (int i = 6; tDataArray.length > i; i++) {
                    tOres += (tDataArray[i] + " ");
                }
                tNBTList.func_74742_a(new NBTTagString("Prospection Data From: X" + tDataArray[0] + " Z:" + tDataArray[2] + " Dim:" + tDataArray[3] + " Produces " + tDataArray[4] + "L " + tDataArray[5] + " " + tOres));
                tNBT.func_74782_a("pages", tNBTList);
            }
            setNBT(aStack, tNBT);
        }
        ...
        public static void addEnchantment(ItemStack aStack, Enchantment aEnchantment, int aLevel) {
            ...
            if (!tNBT.func_150297_b("ench", 9)) tNBT.func_74782_a("ench", new NBTTagList());
            ...
            for (int i = 0; i < tList.func_74745_c(); i++) {
                ...
                if (tEnchantmentTag.func_74765_d("id") == Enchantment.func_185258_b(aEnchantment)) {
                    tEnchantmentTag.func_74777_a("id", (short) Enchantment.func_185258_b(aEnchantment));
                    tEnchantmentTag.func_74777_a("lvl", (byte) aLevel);
                    temp = false;
                    break;
                }
            }
            ...
            if (temp) {
                ...
                tEnchantmentTag.func_74777_a("id", (short) Enchantment.func_185258_b(aEnchantment));
                tEnchantmentTag.func_74777_a("lvl", (byte) aLevel);
                tList.func_74742_a(tEnchantmentTag);
            }
    ...
    public static class GT_EnchantmentHelper {
        ...
        private static void applyBullshit(IBullshit aBullshitModifier, ItemStack aStack) {
            if (aStack != null) {
                NBTTagList nbttaglist = aStack.func_77986_q();
                if (nbttaglist != null) {
                    for (int i = 0; i < nbttaglist.func_74745_c(); ++i) {
                        try {
                            short short1 = nbttaglist.func_150305_b(i).func_74765_d("id");
                            short short2 = nbttaglist.func_150305_b(i).func_74765_d("lvl");
                            if (Enchantment.func_185262_c(short1) != null)
                                aBullshitModifier.calculateModifier(Enchantment.func_185262_c(short1), short2);
                        } catch (Throwable e) {
                            //
                        }
                    }
        ...
        static final class BullshitIteratorA implements IBullshit {
            ...
            public void calculateModifier(Enchantment aEnchantment, int aLevel) {
                aEnchantment.func_77318_a(aLevel, DamageSource.func_92087_a(mEntity));
            }
        }
        ...
        static final class BullshitIteratorB implements IBullshit {
            ...
            @Override
            public void calculateModifier(Enchantment aEnchantment, int aLevel) {
                aEnchantment.func_77318_a(aLevel, DamageSource.func_76358_a(mPlayer));
            }
        }
    }
