    ...
    public Achievement registerOreAchievement(Materials aMaterial) {
        if (this.achievementList.get(aMaterial.mName) == null) {
            ...
            return registerAchievement(aMaterial.mName, -(6 + oreReg % 5), ((oreReg) / 5) - 8, new ItemStack(GregTech_API.sBlockOres1, 1,
                    aMaterial.mMetaItemSubID), AchievementList.OPEN_INVENTORY, false);
        }
        return null;
    }
...
//		}
    ...
    public void onItemPickup(EntityItemPickupEvent event) {
        ...
        } else if ((stack.getItem() == GT_ModHandler.getIC2Item(ItemName.quantum_chestplate, 1).getItem()) || (stack.getItem() == GT_ModHandler.getIC2Item(ItemName.quantum_boots, 1).getItem()) ||
                (stack.getItem() == GT_ModHandler.getIC2Item(ItemName.quantum_helmet, 1).getItem()) || (stack.getItem() == GT_ModHandler.getIC2Item(ItemName.quantum_leggings, 1).getItem())) {
