    ...
    public int doCoverThings(byte aSide, byte aInputRedstone, int aCoverID, int aCoverVariable, ICoverable aTileEntity, long aTimer) {
        ...
        if ((aTileEntity instanceof IFluidHandler)) {
            ...
            if (aCoverVariable > 0) {
                ...
                directionFrom = EnumFacing.field_82609_l[aSide];
                directionTo = EnumFacing.field_82609_l[aSide].func_176734_d();
            } else {
                tTank1 = aTileEntity.getITankContainerAtSide(aSide);
                tTank2 = (IFluidHandler) aTileEntity;
                directionFrom = EnumFacing.field_82609_l[aSide].func_176734_d();
                directionTo = EnumFacing.field_82609_l[aSide];
            }
