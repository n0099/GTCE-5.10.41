        ...
        if (aTileEntity instanceof IGregTechTileEntity) {
            ...
            if (mTileEntity instanceof GT_MetaTileEntity_MultiBlockBase) {
                ...
                if(aCoverVariable == 10 || aCoverVariable == 11){
                	if(multi.getRealInventory()[1]==null || multi.getRealInventory()[1].func_77973_b()!=GT_MetaGenerated_Tool_01.INSTANCE && multi.getRealInventory()[1].func_77952_i()<170){needsRepair = true;}
                	else{
