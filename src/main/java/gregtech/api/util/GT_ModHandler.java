...
public class GT_ModHandler {
    ...
    private static final ItemStack sMt1 = new ItemStack(Blocks.field_150346_d, 1, 0), sMt2 = new ItemStack(Blocks.field_150346_d, 1, 0);
    ...
    static {
        ...
        sNativeRecipeClasses.add(ic2.core.recipe.AdvRecipe.class.getName());
        sNativeRecipeClasses.add(ic2.core.recipe.AdvShapelessRecipe.class.getName());
    ...
    public static ItemStack getIC2Item(ItemName itemName, int amount, boolean wildcard) {
        ItemStack stack = itemName.getItemStack();
        if(wildcard) stack.func_77964_b(OreDictionary.WILDCARD_VALUE);
        stack.field_77994_a = amount;
        return stack;
    }
    ...
    public static ItemStack getIC2Item(ItemName itemName, int amount, int explicitDamage) {
        ItemStack stack = itemName.getItemStack();
        stack.func_77964_b(explicitDamage);
        stack.field_77994_a = amount;
        return stack;
    }
    ...
    public static FluidStack getDistilledWater(long aAmount) {
        FluidStack tFluid = new FluidStack(FluidName.distilled_water.getInstance(), (int) aAmount);
    ...
    public static int getFuelValue(ItemStack aStack) {
        return TileEntityFurnace.func_145952_a(aStack);
    }
    ...
    public static ItemStack getModItem(String aModID, String aItem, long aAmount, ItemStack aReplacement) {
        ...
        if(stack != null) {
            stack.field_77994_a = (int) aAmount;
            return stack;
        }
        return null;
    }
    ...
    public static boolean addScrapboxDrop(float aChance, ItemStack aOutput) {
        ...
        if (GT_Config.troll && !GT_Utility.areStacksEqual(aOutput, new ItemStack(Items.field_151017_I, 1, 0))) return false;
    ...
    public static boolean addSmeltingRecipe(ItemStack aInput, ItemStack aOutput) {
        ...
        FurnaceRecipes.func_77602_a().func_151394_a(aInput, GT_Utility.copy(aOutput), 0.0F);
        return true;
    }
    ...
    public static boolean addSmeltingAndAlloySmeltingRecipe(ItemStack aInput, ItemStack aOutput, boolean hidden) {
        ...
        boolean temp = false;
        if (aInput.field_77994_a == 1 && addSmeltingRecipe(aInput, aOutput)) temp = true;
        ...
        if (GT_Mod.gregtechproxy.mTEMachineRecipes)
            if (addInductionSmelterRecipe(aInput, null, aOutput, null, aOutput.field_77994_a * 1600, 0)) temp = true;
        return temp;
    }
    ...
    public static boolean addExtractionRecipe(ItemStack aInput, ItemStack aOutput) {
        aOutput = GT_OreDictUnificator.get(true, aOutput);
        if (aInput == null || aOutput == null) return false;
        GT_Utility.removeSimpleIC2MachineRecipe(aInput, Recipes.extractor.getRecipes(), null);
        if (!GregTech_API.sRecipeFile.get(ConfigCategories.Machines.extractor, aInput, true)) return false;
        GT_Utility.addSimpleIC2MachineRecipe(aInput, Recipes.extractor, null, aOutput);
        return true;
    }
    ...
    public static boolean addPulverisationRecipe(ItemStack aInput, ItemStack aOutput1, ItemStack aOutput2, int aChance2, ItemStack aOutput3, int aChance3, boolean aOverwrite) {
        ...
        GT_Utility.removeSimpleIC2MachineRecipe(aInput, Recipes.macerator.getRecipes(), null);

        if (GT_Utility.getContainerItem(aInput, false) == null) {
            if (GregTech_API.sRecipeFile.get(ConfigCategories.Machines.maceration, aInput, true)) {
                GT_Utility.addSimpleIC2MachineRecipe(aInput, Recipes.macerator, null, aOutput1);
            }
...
//                            }
    ...
    public static boolean addImmersiveEngineeringRecipe(ItemStack aInput, ItemStack aOutput1, ItemStack aOutput2, int aChance2, ItemStack aOutput3, int aChance3){
        if(GregTech_API.mImmersiveEngineering && GT_Mod.gregtechproxy.mImmersiveEngineeringRecipes){
            //TODO blusunrize.immersiveengineering.common.IERecipes.addCrusherRecipe(aOutput1, aInput, 6000, aOutput2, 0.15f);
        }
        return true;
    }
        ...
        if(GregTech_API.mMagneticraft && GT_Mod.gregtechproxy.mMagneticraftRecipes){
            ...
            if(tData!=null&&tData.mPrefix!=null){
                if(tData.mPrefix==OrePrefixes.ore||tData.mPrefix==OrePrefixes.oreBlackgranite||tData.mPrefix==OrePrefixes.oreEndstone||tData.mPrefix==OrePrefixes.oreNetherrack||tData.mPrefix==OrePrefixes.oreRedgranite){
                    //TODO com.cout970.magneticraft.api.access.MgRecipeRegister.registerCrusherRecipe(aInput, aOutput1, aOutput2,(float)((float)aChance2/GT_Mod.gregtechproxy.mMagneticraftBonusOutputPercent), aOutput3,(float)((float)aChance3/GT_Mod.gregtechproxy.mMagneticraftBonusOutputPercent));
                    ...
                    //TODO com.cout970.magneticraft.api.access.MgRecipeRegister.registerGrinderRecipe(aInput, aOutput1, aOutput2,(float)((float)aChance2/GT_Mod.gregtechproxy.mMagneticraftBonusOutputPercent), aOutput3,(float)((float)aChance3/GT_Mod.gregtechproxy.mMagneticraftBonusOutputPercent));
                }
            }
        }
        return true;
    ...
    public static boolean addInductionSmelterRecipe(ItemStack aInput1, ItemStack aInput2, ItemStack aOutput1, ItemStack aOutput2, int aEnergy, int aChance) {
        ...
        if (!GT_Mod.gregtechproxy.mTEMachineRecipes && !GregTech_API.sRecipeFile.get(ConfigCategories.Machines.inductionsmelter, aInput2 == null ? aInput1 : aOutput1, true))
            return false;
        try {
            ThermalExpansion.addSmelterRecipe(aEnergy * 10, GT_Utility.copy(aInput1), aInput2 == null ? new ItemStack(Blocks.field_150354_m, 1, 0) : aInput2, aOutput1, aOutput2, aChance);
        } catch (Throwable e) {/*Do nothing*/}
        return true;
    }
    ...
    public static boolean addThermalCentrifugeRecipe(ItemStack aInput, int aHeat, Object... aOutput) {
        ...
        GT_Utility.removeSimpleIC2MachineRecipe(aInput, Recipes.centrifuge.getRecipes(), null);
        ...
        GT_Utility.addSimpleIC2MachineRecipe(aInput, Recipes.centrifuge, tNBT, aOutput);
        return true;
    }
    ...
    public static boolean addOreWasherRecipe(ItemStack aInput, int aWaterAmount, Object... aOutput) {
        if (aInput == null || aOutput == null || aOutput.length <= 0 || aOutput[0] == null) return false;
        GT_Utility.removeSimpleIC2MachineRecipe(aInput, Recipes.oreWashing.getRecipes(), null);
        ...
        GT_Utility.addSimpleIC2MachineRecipe(aInput, Recipes.oreWashing, tNBT, aOutput);
        return true;
    }
    ...
    public static boolean addCompressionRecipe(ItemStack aInput, ItemStack aOutput) {
        ...
        GT_Utility.removeSimpleIC2MachineRecipe(aInput, Recipes.compressor.getRecipes(), null);
        if (!GregTech_API.sRecipeFile.get(ConfigCategories.Machines.compression, aInput, true)) return false;
        GT_Utility.addSimpleIC2MachineRecipe(aInput, Recipes.compressor, null, aOutput);
        return true;
    }
    ...
    public static boolean addRollingMachineRecipe(ItemStack aResult, Object[] aRecipe) {
        ...
        if (aResult == null || aRecipe == null || aResult.field_77994_a <= 0) return false;
        try {
    ...
    private static boolean addCraftingRecipe(ItemStack aResult, Enchantment[] aEnchantmentsAdded, int[] aEnchantmentLevelsAdded, boolean aMirrored, boolean aBuffered, boolean aKeepNBT, boolean aDismantleable, boolean aRemovable, boolean aReversible, boolean aRemoveAllOthersWithSameOutput, boolean aRemoveAllOthersWithSameOutputIfTheyHaveSameNBT, boolean aRemoveAllOtherShapedsWithSameOutput, boolean aRemoveAllOtherNativeRecipes, boolean aCheckForCollisions, boolean aOnlyAddIfThereIsAnyRecipeOutputtingThis, boolean aOnlyAddIfResultIsNotNull, Object[] aRecipe) {
        ...
        if (aResult != null && Items.field_151008_G.getDamage(aResult) == W) Items.field_151008_G.setDamage(aResult, 0);
        ...
        try {
            ...
            if (aCheckForCollisions && tRemoveRecipe) {
                ...
                for (char chr : shape.toCharArray()) {
                    ...
                    if (tRecipe[x] != null && Items.field_151008_G.getDamage(tRecipe[x]) == W)
        ...
        if (aResult == null || aResult.field_77994_a <= 0) return false;
        ...
        if (aOnlyAddIfThereIsAnyRecipeOutputtingThis && !tThereWasARecipe) {
            ArrayList<IRecipe> tList = (ArrayList<IRecipe>) CraftingManager.func_77594_a().func_77592_b();
            int tList_sS=tList.size();
            for (int i = 0; i < tList_sS && !tThereWasARecipe; i++) {
                IRecipe tRecipe = tList.get(i);
                if (sSpecialRecipeClasses.contains(tRecipe.getClass().getName())) continue;
                if (GT_Utility.areStacksEqual(GT_OreDictUnificator.get(tRecipe.func_77571_b()), aResult, true)) {
        ...
        if (Items.field_151008_G.getDamage(aResult) == W || Items.field_151008_G.getDamage(aResult) < 0)
    ...
    public static ItemStack removeRecipe(ItemStack... aRecipe) {
        ...
        for (int i = 0; i < aRecipe.length && i < 9; i++) aCrafting.func_70299_a(i, aRecipe[i]);
        ArrayList<IRecipe> tList = (ArrayList<IRecipe>) CraftingManager.func_77594_a().func_77592_b();
        int tList_sS=tList.size();
        try {
            for (int i = 0; i < tList_sS; i++) {
                for (; i < tList_sS; i++) {
                    if ((!(tList.get(i) instanceof IGT_CraftingRecipe) || ((IGT_CraftingRecipe) tList.get(i)).isRemovable()) && tList.get(i).func_77569_a(aCrafting, DW)) {
                        rReturn = tList.get(i).func_77572_b(aCrafting);
    ...
    public static ItemStack getAllRecipeOutput(World aWorld, ItemStack... aRecipe) {
        ...
        for (int i = 0; i < 9 && i < aRecipe.length; i++) aCrafting.func_70299_a(i, aRecipe[i]);
        List<IRecipe> tList = CraftingManager.func_77594_a().func_77592_b();
        synchronized (sAllRecipeList) {
            ...
            for (int i = 0, j = sAllRecipeList.size(); i < j; i++) {
                ...
                if (tRecipe.func_77569_a(aCrafting, aWorld)) {
                    if (i > 10) {
        ...
        for (int i = 0, j = aCrafting.func_70302_i_(); i < j; i++) {
        ...
        if (tIndex == 2) {
            ...
            if (tStack1.func_77973_b() == tStack2.func_77973_b() && tStack1.field_77994_a == 1 && tStack2.field_77994_a == 1 && tStack1.func_77973_b().isRepairable()) {
                int tNewDamage = tStack1.func_77958_k() + tStack1.func_77952_i() - tStack2.func_77952_i() + tStack1.func_77958_k() / 20;
    ...
    public static ItemStack getRecipeOutput(boolean aUncopiedStack, ItemStack... aRecipe) {
        ...
        for (int i = 0; i < tList.size(); i++) {
            temp = false;
            try {
                temp = tList.get(i).func_77569_a(aCrafting, DW);
            } catch (Throwable e) {
                e.printStackTrace(GT_Log.err);
            }
            if (temp) {
                ItemStack tOutput = aUncopiedStack ? tList.get(i).func_77571_b() : tList.get(i).func_77572_b(aCrafting);
    ...
    public static ArrayList<ItemStack> getVanillyToolRecipeOutputs(ItemStack... aRecipe) {
        ...
        if (sSingleNonBlockDamagableRecipeList.isEmpty()) {
            for (IRecipe tRecipe : (ArrayList<IRecipe>) CraftingManager.func_77594_a().func_77592_b()) {
                ItemStack tStack = tRecipe.func_77571_b();
                if (GT_Utility.isStackValid(tStack) && tStack.func_77976_d() == 1 && tStack.func_77958_k() > 0 && !(tStack.func_77973_b() instanceof ItemBlock) && !(tStack.func_77973_b() instanceof IReactorComponent) && !isElectricItem(tStack) && !GT_Utility.isStackInList(tStack, sNonReplaceableItems)) {
                    if (!(tRecipe instanceof ShapelessRecipes || tRecipe instanceof ShapelessOreRecipe)) {
                        if (tRecipe instanceof ShapedOreRecipe) {
                            ...
                            boolean temp = true;
                            for (ItemStack tObject : ((ShapedRecipes) tRecipe).field_77574_d) {
    ...
    public static ArrayList<ItemStack> getRecipeOutputs(List<IRecipe> aList, boolean aDeleteFromList, ItemStack... aRecipe) {
        ...
        for (int i = 0; i < aList.size(); i++) {
            temp = false;
            try {
                temp = aList.get(i).func_77569_a(aCrafting, DW);
            } catch (Throwable e) {
                e.printStackTrace(GT_Log.err);
            }
            if (temp) {
    ...
    public static ItemStack getMaceratorOutput(ItemStack aInput, boolean aRemoveInput, ItemStack aOutputSlot) {
        return GT_Utility.copy(getMachineOutput(aInput, Recipes.macerator.getRecipes(), aRemoveInput, new NBTTagCompound(), aOutputSlot)[0]);
    }
    ...
    public static ItemStack getExtractorOutput(ItemStack aInput, boolean aRemoveInput, ItemStack aOutputSlot) {
        return GT_Utility.copy(getMachineOutput(aInput, Recipes.extractor.getRecipes(), aRemoveInput, new NBTTagCompound(), aOutputSlot)[0]);
    }
    ...
    public static ItemStack getCompressorOutput(ItemStack aInput, boolean aRemoveInput, ItemStack aOutputSlot) {
        return GT_Utility.copy(getMachineOutput(aInput, Recipes.compressor.getRecipes(), aRemoveInput, new NBTTagCompound(), aOutputSlot)[0]);
    }
    ...
    public static ItemStack getSmeltingOutput(ItemStack aInput, boolean aRemoveInput, ItemStack aOutputSlot) {
        if (aInput == null || aInput.field_77994_a < 1) return null;
        ...
        if (rStack != null && (aOutputSlot == null || (GT_Utility.areStacksEqual(rStack, aOutputSlot) && rStack.field_77994_a + aOutputSlot.field_77994_a <= aOutputSlot.func_77976_d()))) {
            if (aRemoveInput) aInput.field_77994_a--;
            return rStack;
        }
        return null;
    }
     ...
     */
    public static ItemStack[] getMachineOutput(ItemStack aInput, Iterable<IMachineRecipeManager.RecipeIoContainer> aRecipeList, boolean aRemoveInput, NBTTagCompound rRecipeMetaData, ItemStack... aOutputSlots) {
        ...
        try {
            for (IMachineRecipeManager.RecipeIoContainer tEntry : aRecipeList) {
                if (tEntry.input.matches(aInput)) {
                    if (tEntry.input.getAmount() <= aInput.field_77994_a) {
                        ...
                        if(tEntry.output.metadata != null) {
                            rRecipeMetaData.func_74782_a("return", tEntry.output.metadata);
                        }
                        ...
                        if (aRemoveInput) aInput.field_77994_a -= tEntry.input.getAmount();
                        return rList;
                    }
                    break;
                }
    ...
    public static boolean damageOrDechargeItem(ItemStack aStack, int aDamage, int aDecharge, EntityLivingBase aPlayer) {
        if (GT_Utility.isStackInvalid(aStack) || (aStack.func_77976_d() <= 1 && aStack.field_77994_a > 1)) return false;
        ...
        if (aStack.func_77973_b() instanceof IDamagableItem) {
            ...
            if (aPlayer == null) {
                aStack.func_77964_b(aStack.func_77952_i() + aDamage);
            } else {
            ...
            if (aStack.func_77952_i() >= aStack.func_77958_k()) {
                ...
                if (tStack != null) {
                    ...
                    aStack.func_77964_b(tStack.func_77952_i());
    ...
    public static boolean useSolderingIron(ItemStack aStack, EntityLivingBase aPlayer) {
        ...
        if (GT_Utility.isStackInList(aStack, GregTech_API.sSolderingToolList)) {
            if (aPlayer instanceof EntityPlayer) {
                ...
                if (tPlayer.field_71075_bZ.field_75098_d) return true;
                if (isElectricItem(aStack) && ic2.api.item.ElectricItem.manager.getCharge(aStack) > 1000.0d) {
                    for (int i = 0; i < tPlayer.field_71071_by.field_70462_a.length; i++) {
                        if (GT_Utility.isStackInList(tPlayer.field_71071_by.field_70462_a[i], GregTech_API.sSolderingMetalList)) {
                            if (tPlayer.field_71071_by.field_70462_a[i].field_77994_a < 1) return false;
                            if (tPlayer.field_71071_by.field_70462_a[i].field_77994_a == 1) {
                                tPlayer.field_71071_by.field_70462_a[i] = null;
                            } else {
                                tPlayer.field_71071_by.field_70462_a[i].field_77994_a--;
                            }
                            if (tPlayer.field_71069_bz != null) tPlayer.field_71069_bz.func_75142_b();
    ...
    public static boolean isChargerItem(ItemStack aStack) {
        try {
            if (aStack != null && isElectricItem(aStack)) {
                if (aStack.func_77973_b() instanceof ISpecialElectricItem) {
                    return true;
                } else if (aStack.func_77973_b() instanceof IElectricItem) {
    ...
    public static boolean isElectricItem(ItemStack aStack) {
        try {
            return aStack != null && (aStack.func_77973_b() instanceof IElectricItem || aStack.func_77973_b() instanceof ISpecialElectricItem);
        } catch (Throwable e) {/*Do nothing*/}
        return false;
    }
    ...
    public static int getCapsuleCellContainerCountMultipliedWithStackSize(ItemStack... aStacks) {
        ...
        for (ItemStack tStack : aStacks)
            if (tStack != null) rAmount += getCapsuleCellContainerCount(tStack) * tStack.field_77994_a;
        return rAmount;
    }
    ...
    public static class ThermalExpansion {
        public static void addFurnaceRecipe(int energy, ItemStack input, ItemStack output) {
            ...
            toSend.func_74782_a("input", new NBTTagCompound());
            toSend.func_74782_a("output", new NBTTagCompound());
        ...
        public static void addPulverizerRecipe(int energy, ItemStack input, ItemStack primaryOutput, ItemStack secondaryOutput, int secondaryChance) {
            ...
            toSend.func_74768_a("energy", energy);
            toSend.func_74782_a("input", new NBTTagCompound());
            toSend.func_74782_a("primaryOutput", new NBTTagCompound());
            toSend.func_74782_a("secondaryOutput", new NBTTagCompound());
            input.func_77955_b(toSend.func_74775_l("input"));
            primaryOutput.func_77955_b(toSend.func_74775_l("primaryOutput"));
            if (secondaryOutput != null) secondaryOutput.func_77955_b(toSend.func_74775_l("secondaryOutput"));
        ...
        public static void addSmelterRecipe(int energy, ItemStack primaryInput, ItemStack secondaryInput, ItemStack primaryOutput, ItemStack secondaryOutput, int secondaryChance) {
            ...
            NBTTagCompound toSend = new NBTTagCompound();
            toSend.func_74768_a("energy", energy);
            toSend.func_74782_a("primaryInput", new NBTTagCompound());
            toSend.func_74782_a("secondaryInput", new NBTTagCompound());
            toSend.func_74782_a("primaryOutput", new NBTTagCompound());
            toSend.func_74782_a("secondaryOutput", new NBTTagCompound());
        ...
        public static void addTransposerFill(int energy, ItemStack input, ItemStack output, FluidStack fluid, boolean reversible) {
            ...
            toSend.func_74782_a("input", new NBTTagCompound());
            toSend.func_74782_a("output", new NBTTagCompound());
            toSend.func_74782_a("fluid", new NBTTagCompound());
            input.func_77955_b(toSend.func_74775_l("input"));
            output.func_77955_b(toSend.func_74775_l("output"));
