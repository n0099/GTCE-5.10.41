...
public class BaseMetaPipeEntity extends BaseTileEntity implements IGregTechTileEntity, IPipeRenderedTileEntity, IEnergyConductor {
    ...
    public NBTTagCompound func_189515_b(NBTTagCompound aNBT) {
        ...
        try {
            ...
            aNBT.func_74774_a("mConnections", mConnections);
    ...
    public void setInitialValuesAsNBT(NBTTagCompound aNBT, short aID) {
        if (aNBT == null) {
            ...
            mConnections = aNBT.func_74771_c("mConnections");
    ...
    public void func_73660_a() {
        ...
        if (isServerSide() && mTickTimer % 10 == 0) {
            NW.sendToAllAround(field_145850_b,
                    ...
                    case 11:
                        ...
                        if (isServerSide()) {
                            ...
                            if (mNeedsBlockUpdate) {
                                field_145850_b.func_175685_c(func_174877_v(), func_145838_q());
        ...
        if (isServerSide() && hasValidMetaTileEntity()) {
            ...
            if (tTime > 0 && tTime > GregTech_API.MILLISECOND_THRESHOLD_UNTIL_LAG_WARNING && mTickTimer > 1000 && getMetaTileEntity().doTickProfilingMessageDuringThisTick() && mLagWarningCount++ < 10)
                FMLLog.warning("WARNING: Possible Lag Source at [%s,%s,%s] in Dimension %s with %s ms caused by an instance of %s", getXCoord(), getYCoord(), getZCoord(), field_145850_b.func_72827_u(), tTime, getMetaTileEntity().getClass());
        }
    ...
    public String func_70005_c_() {
        if (canAccessData()) return mMetaTileEntity.func_70005_c_();
        if (GregTech_API.METATILEENTITIES[mID] != null) return GregTech_API.METATILEENTITIES[mID].func_70005_c_();
        return "";
    }

    @Override
    public int func_70297_j_() {
        if (canAccessData()) return mMetaTileEntity.func_70297_j_();
        return 64;
    }

    @Override
    public void func_174889_b(EntityPlayer entityPlayer) {/*Do nothing*/}

    @Override
    public void func_174886_c(EntityPlayer entityPlayer) {/*Do nothing*/}

    @Override
    public boolean func_70300_a(EntityPlayer aPlayer) {
        return hasValidMetaTileEntity() && mTickTimer > 40 && getTileEntityOffset(0, 0, 0) == this && aPlayer.func_70092_e(getXCoord() + 0.5, getYCoord() + 0.5, getZCoord() + 0.5) < 64 && mMetaTileEntity.isAccessAllowed(aPlayer);
    }
    ...
    public boolean func_180462_a(int aIndex, ItemStack aStack, EnumFacing aSide) {
        return canAccessData() && getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsItemsIn((byte) aSide.func_176745_a(), getCoverIDAtSide((byte) aSide.func_176745_a()), getCoverDataAtSide((byte) aSide.func_176745_a()), aIndex, this) && mMetaTileEntity.func_180462_a(aIndex, aStack, aSide);
    }
    ...
    public boolean func_180461_b(int aIndex, ItemStack aStack, EnumFacing aSide) {
        return canAccessData() && getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsItemsOut((byte) aSide.func_176745_a(), getCoverIDAtSide((byte) aSide.func_176745_a()), getCoverDataAtSide((byte) aSide.func_176745_a()), aIndex, this) && mMetaTileEntity.func_180461_b(aIndex, aStack, aSide);
    }
    ...
    public int fill(EnumFacing aSide, FluidStack aFluid, boolean doFill) {
        if (mTickTimer > 5 && canAccessData() && (aSide == null || (mMetaTileEntity.isLiquidInput((byte) aSide.func_176745_a()) && getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsFluidIn((byte) aSide.func_176745_a(), getCoverIDAtSide((byte) aSide.func_176745_a()), getCoverDataAtSide((byte) aSide.func_176745_a()), aFluid == null ? null : aFluid.getFluid(), this))))
    ...
    public FluidStack drain(EnumFacing aSide, int maxDrain, boolean doDrain) {
        if (mTickTimer > 5 && canAccessData() && (aSide == null || (mMetaTileEntity.isLiquidOutput((byte) aSide.func_176745_a()) && getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsFluidOut((byte) aSide.func_176745_a(), getCoverIDAtSide((byte) aSide.func_176745_a()), getCoverDataAtSide((byte) aSide.func_176745_a()), mMetaTileEntity.getFluid() == null ? null : mMetaTileEntity.getFluid().getFluid(), this))))
    ...
    public boolean canFill(EnumFacing aSide, Fluid aFluid) {
        if (mTickTimer > 5 && canAccessData() && (aSide == null || (mMetaTileEntity.isLiquidInput((byte) aSide.func_176745_a()) && getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsFluidIn((byte) aSide.func_176745_a(), getCoverIDAtSide((byte) aSide.func_176745_a()), getCoverDataAtSide((byte) aSide.func_176745_a()), aFluid, this))))
    ...
    public boolean canDrain(EnumFacing aSide, Fluid aFluid) {
        if (mTickTimer > 5 && canAccessData() && (aSide == null || (mMetaTileEntity.isLiquidOutput((byte) aSide.func_176745_a()) && getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsFluidOut((byte) aSide.func_176745_a(), getCoverIDAtSide((byte) aSide.func_176745_a()), getCoverDataAtSide((byte) aSide.func_176745_a()), aFluid, this))))
    ...
    public FluidTankInfo[] getTankInfo(EnumFacing aSide) {
        if (canAccessData() && (aSide == null || (mMetaTileEntity.isLiquidInput((byte) aSide.func_176745_a()) && getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsFluidIn((byte) aSide.func_176745_a(), getCoverIDAtSide((byte) aSide.func_176745_a()), getCoverDataAtSide((byte) aSide.func_176745_a()), null, this)) || (mMetaTileEntity.isLiquidOutput((byte) aSide.func_176745_a()) && getCoverBehaviorAtSide((byte) aSide.func_176745_a()).letsFluidOut((byte) aSide.func_176745_a(), getCoverIDAtSide((byte) aSide.func_176745_a()), getCoverDataAtSide((byte) aSide.func_176745_a()), null, this))))
