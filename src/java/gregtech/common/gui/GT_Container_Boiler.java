...
public class GT_Container_Boiler
    ...
    public void addSlots(InventoryPlayer aInventoryPlayer) {
        func_75146_a(new Slot(this.mTileEntity, 2, 116, 62));
        func_75146_a(new Slot(this.mTileEntity, 0, 44, 26));
        func_75146_a(new Slot(this.mTileEntity, 1, 44, 62));
        func_75146_a(new Slot(this.mTileEntity, 3, 116, 26));
    }
