...
public class ContainerElectricArmor1 extends ContainerBasicArmor {
	...
	public void addSlots(InventoryPlayer aInventoryPlayer) {
		...
		func_75146_a(new Slot(mInvArmor, 9, 118, 60));
		func_75146_a(new Slot(mInvArmor, 10, 136, 60));
		func_75146_a(new Slot(mInvArmor, 11, 154, 60));
		
		func_75146_a(new SlotFluid(mInvArmor,12,94,32));
