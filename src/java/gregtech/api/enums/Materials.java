...
public class Materials implements IColorModulationContainer, ISubTagContainer {
	...
	public static Materials Air = new Materials(120, TextureSet.SET_FLUID, 				1.0F, 0, 2, 16|32, 169, 208, 245, 240, "Air", "Air", 0, 0, -1, 0, false, true, 1, 1, 1, Dyes.dyeLightBlue, 0, Arrays.asList(new MaterialStack(Nitrogen, 40), new MaterialStack(Oxygen, 11), new MaterialStack(Argon, 1), new MaterialStack(NobleGases, 1)));
	...
	static {
		...
		Plastic					.setEnchantmentForTools(getEnchantment("knockback"), 1);
		Rubber					.setEnchantmentForTools(getEnchantment("knockback"), 2);
		InfusedAir				.setEnchantmentForTools(getEnchantment("knockback"), 2);

		IronWood				.setEnchantmentForTools(getEnchantment("fortune"), 1);
		Steeleaf				.setEnchantmentForTools(getEnchantment("fortune"), 2);
		Midasium                .setEnchantmentForTools(getEnchantment("fortune"), 2);
		Mithril					.setEnchantmentForTools(getEnchantment("fortune"), 3);
		Vinteum					.setEnchantmentForTools(getEnchantment("fortune"), 1);
		Thaumium				.setEnchantmentForTools(getEnchantment("fortune"), 2);
		InfusedWater			.setEnchantmentForTools(getEnchantment("fortune"), 3);

		Flint					.setEnchantmentForTools(getEnchantment("fire_aspect"), 1);
		DarkIron				.setEnchantmentForTools(getEnchantment("fire_aspect"), 2);
		Firestone				.setEnchantmentForTools(getEnchantment("fire_aspect"), 3);
		FierySteel				.setEnchantmentForTools(getEnchantment("fire_aspect"), 3);
		Pyrotheum				.setEnchantmentForTools(getEnchantment("fire_aspect"), 3);
		Blaze					.setEnchantmentForTools(getEnchantment("fire_aspect"), 3);
		InfusedFire				.setEnchantmentForTools(getEnchantment("fire_aspect"), 3);

		Force					.setEnchantmentForTools(getEnchantment("silk_touch"), 1);
		Amber					.setEnchantmentForTools(getEnchantment("silk_touch"), 1);
		EnderPearl				.setEnchantmentForTools(getEnchantment("silk_touch"), 1);
		Enderium				.setEnchantmentForTools(getEnchantment("silk_touch"), 1);
		NetherStar				.setEnchantmentForTools(getEnchantment("silk_touch"), 1);
		InfusedOrder			.setEnchantmentForTools(getEnchantment("silk_touch"), 1);

		BlackBronze				.setEnchantmentForTools(getEnchantment("smite"), 2);
		Gold					.setEnchantmentForTools(getEnchantment("smite"), 3);
		RoseGold				.setEnchantmentForTools(getEnchantment("smite"), 4);
		Platinum				.setEnchantmentForTools(getEnchantment("smite"), 5);
		InfusedVis				.setEnchantmentForTools(getEnchantment("smite"), 5);

		Lead					.setEnchantmentForTools(getEnchantment("bane_of_arthropods"), 2);
		Nickel					.setEnchantmentForTools(getEnchantment("bane_of_arthropods"), 2);
		Invar					.setEnchantmentForTools(getEnchantment("bane_of_arthropods"), 3);
		Antimony				.setEnchantmentForTools(getEnchantment("bane_of_arthropods"), 3);
		BatteryAlloy			.setEnchantmentForTools(getEnchantment("bane_of_arthropods"), 4);
		Bismuth					.setEnchantmentForTools(getEnchantment("bane_of_arthropods"), 4);
		BismuthBronze			.setEnchantmentForTools(getEnchantment("bane_of_arthropods"), 5);
		InfusedEarth			.setEnchantmentForTools(getEnchantment("bane_of_arthropods"), 5);

		Iron					.setEnchantmentForTools(getEnchantment("sharpness"), 1);
		Bronze					.setEnchantmentForTools(getEnchantment("sharpness"), 1);
		Brass					.setEnchantmentForTools(getEnchantment("sharpness"), 2);
		HSLA					.setEnchantmentForTools(getEnchantment("sharpness"), 2);
		Steel					.setEnchantmentForTools(getEnchantment("sharpness"), 2);
		WroughtIron				.setEnchantmentForTools(getEnchantment("sharpness"), 2);
		StainlessSteel			.setEnchantmentForTools(getEnchantment("sharpness"), 3);
		Knightmetal				.setEnchantmentForTools(getEnchantment("sharpness"), 3);
		ShadowIron				.setEnchantmentForTools(getEnchantment("sharpness"), 3);
		ShadowSteel				.setEnchantmentForTools(getEnchantment("sharpness"), 4);
		BlackSteel				.setEnchantmentForTools(getEnchantment("sharpness"), 4);
		RedSteel				.setEnchantmentForTools(getEnchantment("sharpness"), 4);
		BlueSteel				.setEnchantmentForTools(getEnchantment("sharpness"), 5);
		DamascusSteel			.setEnchantmentForTools(getEnchantment("sharpness"), 5);
		InfusedEntropy			.setEnchantmentForTools(getEnchantment("sharpness"), 5);
		TungstenCarbide			.setEnchantmentForTools(getEnchantment("sharpness"), 5);
		HSSE					.setEnchantmentForTools(getEnchantment("sharpness"), 5);
		HSSG					.setEnchantmentForTools(getEnchantment("sharpness"), 4);
		HSSS					.setEnchantmentForTools(getEnchantment("sharpness"), 5);

		InfusedAir				.setEnchantmentForArmors(getEnchantment("respiration"), 3);

		InfusedFire				.setEnchantmentForArmors(getEnchantment("feather_falling"), 4);

		Steeleaf				.setEnchantmentForArmors(getEnchantment("protection"), 2);
		Knightmetal				.setEnchantmentForArmors(getEnchantment("protection"), 1);
		InfusedEarth			.setEnchantmentForArmors(getEnchantment("protection"), 4);

		InfusedEntropy			.setEnchantmentForArmors(getEnchantment("thorns"), 3);

		InfusedWater			.setEnchantmentForArmors(getEnchantment("aqua_affinity"), 1);
		IronWood				.setEnchantmentForArmors(getEnchantment("aqua_affinity"), 1);

		InfusedOrder			.setEnchantmentForArmors(getEnchantment("projectile_protection"), 4);

		InfusedDull				.setEnchantmentForArmors(getEnchantment("blast_protection"), 4);

		InfusedVis				.setEnchantmentForArmors(getEnchantment("protection"), 4);
	...
	public boolean contains(ItemStack... aStacks) {
		...
		for (ItemStack tStack : mMaterialItems)
			for (ItemStack aStack : aStacks)
				if (GT_Utility.areStacksEqual(aStack, tStack, !tStack.func_77942_o())) return true;
		return false;
	}
	...
	public static Enchantment getEnchantment(String name) {
		return Enchantment.func_180305_b(name);
	}
