                        ...
                        for (MaterialStack tMat : aMaterial.mMaterialList) {
                            if (tMat.mAmount > 0L) {
                                ...
                                if (tItemAmount + tMat.mAmount * 3628800L <= aStack.func_77976_d() * aMaterial.getDensity()) {
                                    ...
                                    if (tStack != null) {
                                        tStack.field_77994_a = ((int) (tStack.field_77994_a * tDensityMultiplier));
                                        while ((tStack.field_77994_a > 64) && (tCapsuleCount + GT_ModHandler.getCapsuleCellContainerCount(tStack) * 64 < 0L ? tList.size() < 5 : tList.size() < 6) && (tCapsuleCount + GT_ModHandler.getCapsuleCellContainerCount(tStack) * 64 <= 64L)) {
                                        ...
                                        if ((tStack.field_77994_a > 0) && tCapsuleCount + GT_ModHandler.getCapsuleCellContainerCountMultipliedWithStackSize(tStack) <= 64L) {
